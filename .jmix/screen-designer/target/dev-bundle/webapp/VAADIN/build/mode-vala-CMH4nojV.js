...
var modeVala$2 = { exports: {} };
var hasRequiredModeVala;
function requireModeVala() {
  if (hasRequiredModeVala) return modeVala$2.exports;
  hasRequiredModeVala = 1;
  (function(module, exports) {
    ace.define("ace/mode/vala_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.ValaHighlightRules = ValaHighlightRules;
    });
    ...
    ace.define("ace/mode/vala", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/vala_highlight_rules", "ace/mode/folding/cstyle", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/mode/matching_brace_outdent"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      require2("../tokenizer").Tokenizer;
      var ValaHighlightRules = require2("./vala_highlight_rules").ValaHighlightRules;
      require2("./folding/cstyle").FoldMode;
  ...
  return modeVala$2.exports;
}
var modeValaExports = requireModeVala();
const modeVala = /* @__PURE__ */ getDefaultExportFromCjs(modeValaExports);
const modeVala$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeVala
}, [modeValaExports]);
export {
