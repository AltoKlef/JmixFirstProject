    ...
    ace.define("ace/ext/inline_autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/inline", "ace/autocomplete", "ace/autocomplete", "ace/editor", "ace/autocomplete/util", "ace/lib/lang", "ace/lib/dom", "ace/lib/useragent", "ace/ext/language_tools", "ace/ext/language_tools", "ace/ext/language_tools", "ace/config"], function(require2, exports2, module2) {
      ...
      var InlineAutocomplete = (
        ...
        function() {
          ...
          InlineAutocomplete2.prototype.mousewheelListener = function(e) {
          ...
          InlineAutocomplete2.prototype.getCompletionProvider = function() {
            if (!this.completionProvider)
              this.completionProvider = new CompletionProvider();
            return this.completionProvider;
          };
      ...
      var InlineTooltip = (
        /** @class */
        function() {
          function InlineTooltip2(editor, parentElement) {
            this.editor = editor;
          ...
          InlineTooltip2.prototype.setCommands = function(commands) {
          ...
          InlineTooltip2.prototype.show = function() {
            this.detach();
          ...
          InlineTooltip2.prototype.isShown = function() {
            return !!this.htmlElement && window.getComputedStyle(this.htmlElement).display !== "none";
          };
          InlineTooltip2.prototype.updatePosition = function() {
            if (!this.editor) {
              return;
            }
          ...
          InlineTooltip2.prototype.updateButtons = function(force) {
          ...
          InlineTooltip2.prototype.detach = function() {
          ...
          InlineTooltip2.prototype.destroy = function() {
            this.detach();
            if (this.htmlElement) {
      ...
      exports2.InlineTooltip = InlineTooltip;
      exports2.TOOLTIP_ID = TOOLTIP_ID;
