...
var modeApache_conf$2 = { exports: {} };
var hasRequiredModeApache_conf;
function requireModeApache_conf() {
  if (hasRequiredModeApache_conf) return modeApache_conf$2.exports;
  hasRequiredModeApache_conf = 1;
  (function(module, exports) {
    ace.define("ace/mode/apache_conf_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.ApacheConfHighlightRules = ApacheConfHighlightRules;
    });
    ...
    ace.define("ace/mode/apache_conf", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/apache_conf_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var ApacheConfHighlightRules = require2("./apache_conf_highlight_rules").ApacheConfHighlightRules;
  ...
  return modeApache_conf$2.exports;
}
var modeApache_confExports = requireModeApache_conf();
const modeApache_conf = /* @__PURE__ */ getDefaultExportFromCjs(modeApache_confExports);
const modeApache_conf$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeApache_conf
}, [modeApache_confExports]);
export {
  modeApache_conf$1 as m
};
