...
var modeVisualforce$2 = { exports: {} };
var hasRequiredModeVisualforce;
function requireModeVisualforce() {
  if (hasRequiredModeVisualforce) return modeVisualforce$2.exports;
  hasRequiredModeVisualforce = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/visualforce_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlHighlightRules = require2("../mode/html_highlight_rules").HtmlHighlightRules;
      ...
      exports2.VisualforceHighlightRules = VisualforceHighlightRules;
    });
    ace.define("ace/mode/visualforce", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/visualforce_highlight_rules", "ace/mode/behaviour/xml", "ace/mode/folding/html"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlMode = require2("./html").Mode;
      var VisualforceHighlightRules = require2("./visualforce_highlight_rules").VisualforceHighlightRules;
      var XmlBehaviour = require2("./behaviour/xml").XmlBehaviour;
      var HtmlFoldMode = require2("./folding/html").FoldMode;
  ...
  return modeVisualforce$2.exports;
}
var modeVisualforceExports = requireModeVisualforce();
const modeVisualforce = /* @__PURE__ */ getDefaultExportFromCjs(modeVisualforceExports);
const modeVisualforce$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeVisualforce
}, [modeVisualforceExports]);
export {
  modeVisualforce$1 as m
};
