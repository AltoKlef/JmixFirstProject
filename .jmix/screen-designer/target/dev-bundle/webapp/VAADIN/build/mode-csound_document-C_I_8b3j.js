...
var modeCsound_document$2 = { exports: {} };
var hasRequiredModeCsound_document;
function requireModeCsound_document() {
  if (hasRequiredModeCsound_document) return modeCsound_document$2.exports;
  hasRequiredModeCsound_document = 1;
  (function(module, exports) {
    ace.define("ace/mode/csound_preprocessor_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      var CsoundPreprocessorHighlightRules = function(embeddedRulePrefix) {
        this.embeddedRulePrefix = embeddedRulePrefix === void 0 ? "" : embeddedRulePrefix;
        ...
        this.pushRule = function(params) {
          ...
          return {
            ...
            onMatch: function(value, currentState, stack, line) {
              ...
              if (Array.isArray(params.next)) {
                for (var i2 = 0; i2 < params.next.length; i2++) {
                  stack.push(params.next[i2]);
                }
              } else {
      ...
      exports2.CsoundPreprocessorHighlightRules = CsoundPreprocessorHighlightRules;
    });
    ace.define("ace/mode/csound_score_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/csound_preprocessor_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var CsoundPreprocessorHighlightRules = require2("./csound_preprocessor_highlight_rules").CsoundPreprocessorHighlightRules;
      ...
      exports2.CsoundScoreHighlightRules = CsoundScoreHighlightRules;
    });
    ...
    ace.define("ace/mode/csound_orchestra_highlight_rules", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/mode/csound_preprocessor_highlight_rules", "ace/mode/csound_score_highlight_rules", "ace/mode/lua_highlight_rules", "ace/mode/python_highlight_rules"], function(require2, exports2, module2) {
      var lang = require2("../lib/lang");
      var oop = require2("../lib/oop");
      var CsoundPreprocessorHighlightRules = require2("./csound_preprocessor_highlight_rules").CsoundPreprocessorHighlightRules;
      var CsoundScoreHighlightRules = require2("./csound_score_highlight_rules").CsoundScoreHighlightRules;
      ...
      exports2.CsoundOrchestraHighlightRules = CsoundOrchestraHighlightRules;
    });
    ...
    ace.define("ace/mode/csound_document_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/csound_orchestra_highlight_rules", "ace/mode/csound_score_highlight_rules", "ace/mode/html_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var CsoundOrchestraHighlightRules = require2("./csound_orchestra_highlight_rules").CsoundOrchestraHighlightRules;
      var CsoundScoreHighlightRules = require2("./csound_score_highlight_rules").CsoundScoreHighlightRules;
      ...
      exports2.CsoundDocumentHighlightRules = CsoundDocumentHighlightRules;
    });
    ace.define("ace/mode/csound_document", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/csound_document_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var CsoundDocumentHighlightRules = require2("./csound_document_highlight_rules").CsoundDocumentHighlightRules;
      var Mode = function() {
  ...
  })(modeCsound_document$2);
  return modeCsound_document$2.exports;
}
var modeCsound_documentExports = requireModeCsound_document();
const modeCsound_document = /* @__PURE__ */ getDefaultExportFromCjs(modeCsound_documentExports);
const modeCsound_document$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeCsound_document
}, [modeCsound_documentExports]);
export {
  modeCsound_document$1 as m
};
