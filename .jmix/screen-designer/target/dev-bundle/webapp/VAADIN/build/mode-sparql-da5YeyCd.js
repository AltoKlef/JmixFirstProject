...
var modeSparql$2 = { exports: {} };
var hasRequiredModeSparql;
function requireModeSparql() {
  if (hasRequiredModeSparql) return modeSparql$2.exports;
  hasRequiredModeSparql = 1;
  (function(module, exports) {
    ace.define("ace/mode/sparql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.SPARQLHighlightRules = SPARQLHighlightRules;
    });
    ...
    ace.define("ace/mode/sparql", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sparql_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var SPARQLHighlightRules = require2("./sparql_highlight_rules").SPARQLHighlightRules;
  ...
  return modeSparql$2.exports;
}
var modeSparqlExports = requireModeSparql();
const modeSparql = /* @__PURE__ */ getDefaultExportFromCjs(modeSparqlExports);
const modeSparql$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeSparql
}, [modeSparqlExports]);
export {
