...
var modeNsis$2 = { exports: {} };
var hasRequiredModeNsis;
function requireModeNsis() {
  if (hasRequiredModeNsis) return modeNsis$2.exports;
  hasRequiredModeNsis = 1;
  (function(module, exports) {
    ace.define("ace/mode/nsis_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.NSISHighlightRules = NSISHighlightRules;
    });
    ...
    ace.define("ace/mode/nsis", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/nsis_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var NSISHighlightRules = require2("./nsis_highlight_rules").NSISHighlightRules;
  ...
  return modeNsis$2.exports;
}
var modeNsisExports = requireModeNsis();
const modeNsis = /* @__PURE__ */ getDefaultExportFromCjs(modeNsisExports);
const modeNsis$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeNsis
}, [modeNsisExports]);
export {
