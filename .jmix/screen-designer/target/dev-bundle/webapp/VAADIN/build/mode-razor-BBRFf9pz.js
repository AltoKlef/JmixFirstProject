...
var modeRazor$2 = { exports: {} };
var hasRequiredModeRazor;
function requireModeRazor() {
  if (hasRequiredModeRazor) return modeRazor$2.exports;
  hasRequiredModeRazor = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/razor_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/doc_comment_highlight_rules", "ace/mode/html_highlight_rules", "ace/mode/csharp_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var lang = require2("../lib/lang");
      ...
      exports2.RazorHighlightRules = RazorHighlightRules;
      exports2.RazorLangHighlightRules = RazorLangHighlightRules;
    });
    ace.define("ace/mode/razor_completions", ["require", "exports", "module", "ace/token_iterator"], function(require2, exports2, module2) {
      require2("../token_iterator").TokenIterator;
      var keywords = [
        "abstract",
        "as",
        "base",
      ...
      exports2.RazorCompletions = RazorCompletions;
    });
    ace.define("ace/mode/razor", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/razor_highlight_rules", "ace/mode/razor_completions", "ace/mode/html_completions"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlMode = require2("./html").Mode;
      var RazorHighlightRules = require2("./razor_highlight_rules").RazorHighlightRules;
      var RazorCompletions = require2("./razor_completions").RazorCompletions;
      var HtmlCompletions = require2("./html_completions").HtmlCompletions;
      var Mode = function() {
        HtmlMode.call(this);
  ...
  return modeRazor$2.exports;
}
var modeRazorExports = requireModeRazor();
const modeRazor = /* @__PURE__ */ getDefaultExportFromCjs(modeRazorExports);
const modeRazor$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeRazor
}, [modeRazorExports]);
export {
