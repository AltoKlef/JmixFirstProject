...
var modeRaku$2 = { exports: {} };
var hasRequiredModeRaku;
function requireModeRaku() {
  if (hasRequiredModeRaku) return modeRaku$2.exports;
  hasRequiredModeRaku = 1;
  (function(module, exports) {
    ace.define("ace/mode/raku_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.RakuHighlightRules = RakuHighlightRules;
    });
    ...
    ace.define("ace/mode/raku", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/raku_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var RakuHighlightRules = require2("./raku_highlight_rules").RakuHighlightRules;
  ...
  return modeRaku$2.exports;
}
var modeRakuExports = requireModeRaku();
const modeRaku = /* @__PURE__ */ getDefaultExportFromCjs(modeRakuExports);
const modeRaku$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeRaku
}, [modeRakuExports]);
export {
