...
var modeLsl$2 = { exports: {} };
var hasRequiredModeLsl;
function requireModeLsl() {
  if (hasRequiredModeLsl) return modeLsl$2.exports;
  hasRequiredModeLsl = 1;
  (function(module, exports) {
    ace.define("ace/mode/lsl_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.LSLHighlightRules = LSLHighlightRules;
    });
    ...
    ace.define("ace/mode/lsl", ["require", "exports", "module", "ace/mode/lsl_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/text", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/lib/oop"], function(require2, exports2, module2) {
      var Rules = require2("./lsl_highlight_rules").LSLHighlightRules;
  ...
  return modeLsl$2.exports;
}
var modeLslExports = requireModeLsl();
const modeLsl = /* @__PURE__ */ getDefaultExportFromCjs(modeLslExports);
const modeLsl$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeLsl
}, [modeLslExports]);
export {
