...
var modeSlim$2 = { exports: {} };
var hasRequiredModeSlim;
function requireModeSlim() {
  if (hasRequiredModeSlim) return modeSlim$2.exports;
  hasRequiredModeSlim = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/coffee", ["require", "exports", "module", "ace/mode/coffee_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/coffee", "ace/range", "ace/mode/text", "ace/worker/worker_client", "ace/lib/oop"], function(require2, exports2, module2) {
      var Rules = require2("./coffee_highlight_rules").CoffeeHighlightRules;
      var Outdent = require2("./matching_brace_outdent").MatchingBraceOutdent;
    ...
    ace.define("ace/mode/scss", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/scss_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/folding/cstyle", "ace/mode/css_completions"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
    ...
    ace.define("ace/mode/less", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/less_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/css_completions", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
    ...
    ace.define("ace/mode/ruby_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      var constantNumericOctal = exports2.constantNumericDecimal = {
        token: "constant.numeric",
    ...
    ace.define("ace/mode/ruby", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/ruby_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/ruby"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
    ...
    ace.define("ace/mode/slim", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/slim_highlight_rules", "ace/mode/javascript", "ace/mode/markdown", "ace/mode/coffee", "ace/mode/scss", "ace/mode/sass", "ace/mode/less", "ace/mode/ruby", "ace/mode/css"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      ...
      var Mode = function() {
        ...
        this.createModeDelegates({
          javascript: require2("./javascript").Mode,
          markdown: require2("./markdown").Mode,
          coffee: require2("./coffee").Mode,
          scss: require2("./scss").Mode,
          sass: require2("./sass").Mode,
          less: require2("./less").Mode,
          ruby: require2("./ruby").Mode,
          css: require2("./css").Mode
        });
      };
      oop.inherits(Mode, TextMode);
  ...
  return modeSlim$2.exports;
}
var modeSlimExports = requireModeSlim();
const modeSlim = /* @__PURE__ */ getDefaultExportFromCjs(modeSlimExports);
const modeSlim$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeSlim
}, [modeSlimExports]);
export {
