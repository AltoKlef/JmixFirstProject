...
var modeGobstones$2 = { exports: {} };
var hasRequiredModeGobstones;
function requireModeGobstones() {
  if (hasRequiredModeGobstones) return modeGobstones$2.exports;
  hasRequiredModeGobstones = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/gobstones_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.GobstonesHighlightRules = GobstonesHighlightRules;
    });
    ace.define("ace/mode/gobstones", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/mode/gobstones_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var JavaScriptMode = require2("./javascript").Mode;
      var GobstonesHighlightRules = require2("./gobstones_highlight_rules").GobstonesHighlightRules;
      var Mode = function() {
  ...
  return modeGobstones$2.exports;
}
var modeGobstonesExports = requireModeGobstones();
const modeGobstones = /* @__PURE__ */ getDefaultExportFromCjs(modeGobstonesExports);
const modeGobstones$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeGobstones
}, [modeGobstonesExports]);
export {
  modeGobstones$1 as m
};
