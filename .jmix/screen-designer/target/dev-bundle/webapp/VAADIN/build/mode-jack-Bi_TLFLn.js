...
var modeJack$2 = { exports: {} };
var hasRequiredModeJack;
function requireModeJack() {
  if (hasRequiredModeJack) return modeJack$2.exports;
  hasRequiredModeJack = 1;
  (function(module, exports) {
    ace.define("ace/mode/jack_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.JackHighlightRules = JackHighlightRules;
    });
    ...
    ace.define("ace/mode/jack", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/jack_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var HighlightRules = require2("./jack_highlight_rules").JackHighlightRules;
  ...
  return modeJack$2.exports;
}
var modeJackExports = requireModeJack();
const modeJack = /* @__PURE__ */ getDefaultExportFromCjs(modeJackExports);
const modeJack$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeJack
}, [modeJackExports]);
export {
