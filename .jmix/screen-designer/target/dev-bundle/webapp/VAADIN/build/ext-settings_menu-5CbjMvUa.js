...
var extSettings_menu$2 = { exports: {} };
var hasRequiredExtSettings_menu;
function requireExtSettings_menu() {
  if (hasRequiredExtSettings_menu) return extSettings_menu$2.exports;
  hasRequiredExtSettings_menu = 1;
  (function(module, exports) {
    ...
    ace.define("ace/ext/modelist", ["require", "exports", "module"], function(require2, exports2, module2) {
      var modes = [];
    ...
    ace.define("ace/ext/options", ["require", "exports", "module", "ace/ext/menu_tools/overlay_page", "ace/lib/dom", "ace/lib/oop", "ace/config", "ace/lib/event_emitter", "ace/ext/modelist", "ace/ext/themelist"], function(require2, exports2, module2) {
      require2("./menu_tools/overlay_page");
      var dom = require2("../lib/dom");
      var oop = require2("../lib/oop");
      var config = require2("../config");
      var EventEmitter = require2("../lib/event_emitter").EventEmitter;
      var buildDom = dom.buildDom;
      var modelist = require2("./modelist");
      var themelist = require2("./themelist");
    ...
    ace.define("ace/ext/settings_menu", ["require", "exports", "module", "ace/ext/options", "ace/ext/menu_tools/overlay_page", "ace/editor"], function(require2, exports2, module2) {
      var OptionPanel = require2("./options").OptionPanel;
  ...
  return extSettings_menu$2.exports;
}
var extSettings_menuExports = requireExtSettings_menu();
const extSettings_menu = /* @__PURE__ */ getDefaultExportFromCjs(extSettings_menuExports);
const extSettings_menu$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: extSettings_menu
}, [extSettings_menuExports]);
export {
  extSettings_menu$1 as e
};
