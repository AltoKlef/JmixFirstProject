import { p as commonjsGlobal, o as getDefaultExportFromCjs } from "./indexhtml-CE3rDMXe.js";
...
var workerJavascript$2 = {};
var hasRequiredWorkerJavascript;
function requireWorkerJavascript() {
  if (hasRequiredWorkerJavascript) return workerJavascript$2;
  hasRequiredWorkerJavascript = 1;
  !function(window2) {
  ...
  ace.define("ace/mode/javascript/jshint", [], function(require2, exports, module) {
    module.exports = function outer(modules, cache, entry) {
      var previousRequire = typeof require2 == "function" && require2;
      function newRequire(name, jumped) {
        if (!cache[name]) {
          if (!modules[name]) {
            var currentRequire = typeof require2 == "function" && require2;
            if (currentRequire) return currentRequire(name, true);
    ...
    }({ "/../../../jshint/data/ascii-identifier-data.js": [function(_dereq_, module2, exports2) {
      ...
      module2.exports = arr;
    }, {}], "/../../../jshint/data/non-ascii-identifier-start.js": [function(_dereq_, module2, exports2) {
      ...
      module2.exports = arr;
    }, {}], "/../../../jshint/node_modules/console-browserify/index.js": [function(_dereq_, module2, exports2) {
      (function(global2) {
        ...
        var console2;
        var times = {};
        if (typeof global2 !== "undefined" && global2.console) {
    ...
    }, { "assert": "/node_modules/assert/assert.js", "date-now": "/../../../jshint/node_modules/date-now/index.js", "util": "/node_modules/util/util.js" }], "/../../../jshint/node_modules/date-now/index.js": [function(_dereq_, module2, exports2) {
      module2.exports = now;
      function now() {
        return (/* @__PURE__ */ new Date()).getTime();
      }
    }, {}], "/../../../jshint/node_modules/lodash.clone/index.js": [function(_dereq_, module2, exports2) {
      (function(global2) {
    ...
    }, {}], "/../../../jshint/node_modules/lodash.slice/index.js": [function(_dereq_, module2, exports2) {
    ...
    }, {}], "/../../../jshint/node_modules/underscore/underscore-umd.js": [function(_dereq_, module2, exports2) {
      (function(global2) {
        (function(global3, factory) {
          typeof exports2 === "object" && typeof module2 !== "undefined" ? module2.exports = factory() : (global3 = typeof globalThis !== "undefined" ? globalThis : global3 || self, function() {
    ...
    }, {}], "/../../../jshint/src/jshint.js": [function(_dereq_, module2, exports2) {
      ...
      var JSHINT = function() {
        var api, bang = {
          ...
          "/": true,
          "%": true
        }, declared, functions, inblock, indent, lookahead, lex, member, membersOnly, predefined, extraModules = [], emitter = new events.EventEmitter();
        function checkOption(name, isStable, t) {
          var type2, validNames;
          if (isStable) {
            type2 = "";
        ...
        function processenforceall() {
          if (state.option.enforceall) {
            for (var enforceopt in options.bool.enforcing) {
              if (state.option[enforceopt] === void 0 && !options.noenforceall[enforceopt]) {
        ...
        function lintingDirective(directiveToken, previous) {
          ...
          if (directiveToken.type === "globals") {
            body.forEach(function(item, idx) {
              ...
              if (key2.charAt(0) === "-") {
                key2 = key2.slice(1);
                JSHINT.blacklist[key2] = key2;
                delete predefined[key2];
              } else {
                predef[key2] = parts.length > 1 && parts[1].trim() === "true";
              }
            });
          ...
          if (directiveToken.type === "jshint" || directiveToken.type === "jslint" || directiveToken.type === "jshint.unstable") {
            body.forEach(function(item) {
              ...
              var numberVal;
              if (!checkOption(key2, directiveToken.type !== "jshint.unstable", directiveToken)) {
                return;
              }
              if (numvals.indexOf(key2) >= 0) {
                if (val !== "false") {
                  numberVal = +val;
                  ...
                  state.option[key2] = numberVal;
                } else {
                  state.option[key2] = key2 === "indent" ? 4 : false;
                }
                return;
              }
              if (key2 === "validthis") {
              ...
              if (val === "true" || val === "false") {
                if (directiveToken.type === "jslint") {
                  tn = options.renamed[key2] || key2;
                  state.option[tn] = val === "true";
                  if (options.inverted[tn] !== void 0) {
                    state.option[tn] = !state.option[tn];
                  }
                } else if (directiveToken.type === "jshint.unstable") {
                  state.option.unstable[key2] = val === "true";
                } else {
                  state.option[key2] = val === "true";
                }
                return;
              }
              error("E002", directiveToken);
        ...
        function isTypoTypeof(left, right, state2) {
          var values;
          if (state2.option.notypeof)
            return false;
          if (!left || !right)
            return false;
          values = state2.inES6() ? typeofValues.es6 : typeofValues.es3;
        ...
        function isGlobalEval(left, state2) {
          var isGlobal = false;
          if (left.type === "this" && state2.funct["(context)"] === null) {
            isGlobal = true;
          } else if (left.type === "(identifier)") {
            if (state2.option.node && left.value === "global") {
              isGlobal = true;
            } else if (state2.option.browser && (left.value === "window" || left.value === "document")) {
              isGlobal = true;
            }
          }
          return isGlobal;
        ...
        function checkLeftSideAssign(context, left, assignToken, options2) {
          var allowDestructuring = options2 && options2.allowDestructuring;
        ...
        function reachable(controlToken) {
          ...
          function isFunction(t2, i2) {
            if (t2.id === "function") {
              return true;
            }
            if (t2.id === "async") {
              t2 = peek(i2);
              return t2.id === "function";
            }
          }
        }
        function parseFinalSemicolon(stmt2) {
          if (state.tokens.next.id !== ";") {
            if (state.tokens.next.isUnclosed) return advance();
            var isSameLine = sameLine(state.tokens.curr, state.tokens.next) && state.tokens.next.id !== "(end)";
            var blockEnd = checkPunctuator(state.tokens.next, "}");
            if (isSameLine && !blockEnd && !(stmt2.id === "do" && state.inES6(true))) {
        ...
        function block(context, ordinary, stmt2, isfunc, isfatarrow, iscase) {
          var a, b = inblock, old_indent = indent, m, t, d;
          inblock = ordinary;
          t = state.tokens.next;
          ...
          if (state.tokens.next.id === "{") {
            ...
            if (isfunc) {
              state.funct["(scope)"].stack();
              if (stmt2 && !isfatarrow && !state.inMoz()) {
        ...
        state.syntax["(no subst template)"] = _.extend({
          ...
          noSubst: true,
          tail: true
          // mark as tail, since it's always the last component
        }, baseTemplateSyntax);
        ...
        prefix("new", function(context) {
          var mp = metaProperty(context, "target", function() {
            ...
            var inFunction, c2 = state.funct;
            while (c2) {
              inFunction = !c2["(global)"];
              if (!c2["(arrow)"]) {
                break;
              }
              c2 = c2["(context)"];
        ...
        prefix("(", function(context, rbp) {
          ...
          if (ret.id === ",") {
            ...
            if (!isNecessary) {
              ...
              isNecessary = opening.beginsStmt && (ret.id === "{" || triggerFnExpr) || triggerFnExpr && (!isEndOfExpr() || state.tokens.prev.id !== "}") || ret.id === "=>" && !isEndOfExpr() || ret.id === "{" && preceeding.id === "=>" || beginsUnaryExpression(ret) && state.tokens.next.id === "**" || preceeding.id === "??" && (ret.id === "&&" || ret.id === "||") || ret.type === "(number)" && checkPunctuator(pn, ".") && /^\d+$/.test(ret.value) || opening.beginsStmt && ret.id === "=" && ret.left.id === "{" || ret.id === "?." && (preceeding.id === "new" || state.tokens.next.type === "(template)");
            }
          }
        ...
        function functionparams(context, options2) {
          var next;
          var paramsIds = [];
          var ident;
          var tokens = [];
          ...
          var pastRest = false;
          var arity = 0;
          var loneArg = options2 && options2.loneArg;
          ...
          next = state.tokens.next;
          if (!options2 || !options2.parsedOpening) {
            advance("(");
          }
          if (state.tokens.next.id === ")") {
            advance(")");
        ...
        function doFunction(context, options2) {
          var f, token, name, statement2, classExprBinding, isGenerator, isArrow, isMethod2, ignoreLoopFunc;
          var oldOption = state.option;
          var oldIgnored = state.ignored;
          var isAsync = context & prodParams.preAsync;
          if (options2) {
            name = options2.name;
            statement2 = options2.statement;
            classExprBinding = options2.classExprBinding;
            isGenerator = options2.type === "generator";
            isArrow = options2.type === "arrow";
            isMethod2 = options2.isMethod;
            ignoreLoopFunc = options2.ignoreLoopFunc;
          }
          ...
          var internallyAccessibleName = !isMethod2 && (name || classExprBinding);
          ...
          var paramsInfo = functionparams(context, options2);
          if (paramsInfo) {
        ...
        function destructuringPattern(context, options2) {
          var isAssignment = options2 && options2.assignment;
          context &= ~prodParams.noin;
          if (!state.inES6()) {
            warning(
              "W104",
          ...
          return destructuringPatternRecursive(context, options2);
        }
        function destructuringPatternRecursive(context, options2) {
          var ids, idx;
          var identifiers = [];
          var openingParsed = options2 && options2.openingParsed;
          var isAssignment = options2 && options2.assignment;
          ...
          var assignmentProperty = function(context2) {
            var id2, expr;
            if (checkPunctuator(state.tokens.next, "[")) {
              advance("[");
              expression(context2, 10);
              advance("]");
              advance(":");
              nextInnerDE();
              ...
              var isRest2 = spreadrest("rest");
              if (isRest2) {
                if (!state.inES9()) {
                  warning("W119", state.tokens.next, "object rest property", "9");
                }
                if (state.tokens.next.type === "(identifier)") {
                  id2 = identifier(context2);
                } else {
                  expr = expression(context2, 10);
                  error("E030", expr, expr.value);
                }
              } else {
                id2 = identifier(context2);
              }
              if (!isRest2 && checkPunctuator(state.tokens.next, ":")) {
                advance(":");
                nextInnerDE();
              } else if (id2) {
                if (isAssignment) {
                  checkLeftSideAssign(context2, state.tokens.curr);
                }
                identifiers.push({ id: id2, token: state.tokens.curr });
              }
              if (isRest2 && checkPunctuator(state.tokens.next, ",")) {
        ...
        function destructuringPatternMatch(tokens, value) {
          ...
          _.zip(tokens, Array.isArray(first) ? first : [first]).forEach(function(val) {
            ...
            if (token && value2)
              token.first = value2;
            else if (token && token.first && !value2)
              warning("W080", token.first, token.first.value);
          });
        }
        function blockVariableStatement(type2, statement2, context) {
          var noin = context & prodParams.noin;
          var isLet = type2 === "let";
          var isConst = type2 === "const";
          var tokens, lone, value, letblock;
          if (!state.inES6()) {
            warning("W104", state.tokens.curr, type2, "6");
          }
          if (isLet && isMozillaLet()) {
            advance("(");
            state.funct["(scope)"].stack();
            letblock = true;
            statement2.declaration = false;
          }
          statement2.first = [];
          for (; ; ) {
            var names = [];
            ...
            if (state.tokens.next.id === "=") {
              statement2.hasInitializer = true;
              advance("=");
            ...
            statement2.first = statement2.first.concat(names);
            if (state.tokens.next.id !== ",") {
              break;
            }
            statement2.hasComma = true;
            advance(",");
            checkComma();
          }
          if (letblock) {
        ...
        var varstatement = stmt("var", function(context) {
          ...
          for (; ; ) {
            ...
            if (_.includes(["{", "["], state.tokens.next.value)) {
              ...
              if (id) {
                tokens.push({ id, token: state.tokens.curr });
              }
              lone = true;
            }
        ...
        blockstmt("function", function(context) {
          ...
          var f = doFunction(context, {
            ...
            // a declaration may already have warned
          });
        ...
        blockstmt("for", function(context) {
          ...
          } else if (state.tokens.next.id === "const" || state.tokens.next.id === "let" && (afterNext.identifier && afterNext.id !== "in" || checkPunctuators(afterNext, ["{", "["]))) {
        ...
        function supportsSuper(type2, funct) {
          if (type2 === "call" && funct["(async)"]) {
            return false;
          }
          if (type2 === "property" && funct["(method)"]) {
            return true;
          }
          if (type2 === "call" && funct["(statement)"] && funct["(statement)"].id === "class") {
            return true;
          }
          if (funct["(arrow)"]) {
            return supportsSuper(type2, funct["(context)"]);
          }
          return false;
        }
        ...
        function destructuringAssignOrJsonValue(context) {
          var block2 = lookupBlockType();
          if (block2.notJson) {
            if (!state.inES6() && block2.isDestAssign) {
        ...
        var itself = function(s, o, g) {
          ...
          api = {
            ...
            getOption: function(name2) {
              return state.option[name2] || null;
            },
            getCache: function(name2) {
              return state.cache[name2];
            },
            setCache: function(name2, value) {
              state.cache[name2] = value;
            },
            warn: function(code, data) {
              warningAt.apply(null, [code, data.line, data.char].concat(data.data));
            },
            on: function(names, listener) {
              names.split(" ").forEach((function(name2) {
      ...
      if (typeof exports2 === "object" && exports2) {
        exports2.JSHINT = JSHINT;
      }
      ...
      Lexer.prototype = {
        ...
        scanComments: function(checks) {
          ...
          var self2 = this;
          function commentToken(label, body2, opt) {
            var special = [
              "jshint",
              "jshint.unstable",
              "jslint",
            ...
            body2 = body2.replace(/\n/g, " ");
            if (label === "/*" && reg.fallsThrough.test(body2)) {
              isSpecial = true;
            ...
            special.forEach(function(str) {
              ...
              if (body2.charAt(str.length) === " " && body2.substr(0, str.length) === str) {
                isSpecial = true;
                label = label + str;
                body2 = body2.substr(str.length);
              }
              if (!isSpecial && body2.charAt(0) === " " && body2.charAt(str.length + 1) === " " && body2.substr(1, str.length) === str) {
                isSpecial = true;
                label = label + " " + str;
                body2 = body2.substr(str.length + 1);
              }
              var strIndex = body2.indexOf(str);
              if (!isSpecial && strIndex >= 0 && body2.charAt(strIndex + str.length) === " ") {
                var isAllWhitespace = body2.substr(0, strIndex).trim().length === 0;
                if (isAllWhitespace) {
                  isSpecial = true;
                  body2 = body2.substr(str.length + strIndex);
                }
              }
              if (!isSpecial) {
                return;
              ...
              switch (str) {
                ...
                case "global":
                  ...
                  break;
                default:
                  var options = body2.split(":").map(function(v) {
                  ...
                  if (options.length === 2) {
                    switch (options[0]) {
                      case "ignore":
                        switch (options[1]) {
                          case "start":
                            self2.ignoringLinterErrors = true;
                            isSpecial = false;
                            break;
                          case "end":
                            self2.ignoringLinterErrors = false;
                            isSpecial = false;
                            break;
                        }
                    }
        ...
        scanIdentifier: function(checks) {
          ...
          var readUnicodeEscapeSequence = (function() {
            ...
            var sequence = this.peek(index + 1) + this.peek(index + 2) + this.peek(index + 3) + this.peek(index + 4);
            var code;
            if (isHex(sequence)) {
          ...
          function removeEscapeSequences(id2) {
            return id2.replace(/\\u([0-9a-fA-F]{4})/g, function(m0, codepoint) {
        ...
        scanRegExp: function(checks) {
          ...
          var translateUFlag = (function(body2) {
            var astralSubstitute = "￿";
            return body2.replace(/\\u\{([0-9a-fA-F]+)\}|\\u([a-fA-F0-9]{4})/g, (function($0, $1, $2) {
          ...
          while (index < length) {
            ...
            if (char === "\\") {
              ...
              if (isCharSet && (this.peek(index) === "-" || isCharSetRange) && reg.regexpCharClasses.test(escapeSequence)) {
                this.triggerAsync(
                  "error",
                  {
                    code: "E016",
          ...
          while (index < length) {
            ...
            if (char === "y") {
              ...
              var hasInvalidEscape = function(groupReferences2, groupCount2, escapedChars2, reg2) {
                var hasInvalidGroup = groupReferences2.some(function(groupReference) {
                  if (groupReference > groupCount2) {
                    return true;
                  }
                });
                if (hasInvalidGroup) {
                ...
                return !escapedChars2.split("").every(function(escapedChar) {
                  return escapedChar === "u" || escapedChar === "/" || escapedChar === "0" || reg2.regexpControlEscapes.test(escapedChar) || reg2.regexpCharClasses.test(escapedChar) || reg2.regexpSyntaxChars.test(escapedChar);
                });
        ...
        next: function(checks) {
          ...
          var match = this.scanComments(checks) || this.scanStringLiteral(checks) || this.scanTemplateLiteral(checks);
          if (match) {
            return match;
          }
          match = this.scanRegExp(checks) || this.scanPunctuator() || this.scanKeyword() || this.scanIdentifier(checks) || this.scanNumericLiteral(checks);
          if (match) {
        ...
        token: function() {
          ...
          var token;
          var create = (function(type, value, isProperty, token2) {
            var obj;
            ...
            if (type === "(identifier)") {
              if (value === "return" || value === "case" || value === "yield" || value === "typeof" || value === "instanceof" || value === "void" || value === "await" || value === "new" || value === "delete" || value === "default" || value === "extends") {
                this.prereg = true;
              }
            ...
            obj.from = this.from;
            if (obj.identifier && token2) obj.raw_text = token2.text || token2.value;
            if (token2 && token2.startLine && token2.startLine !== this.line) {
              obj.startLine = token2.startLine;
            }
            if (token2 && token2.context) {
              obj.context = token2.context;
            }
            if (token2 && token2.depth) {
              obj.depth = token2.depth;
            }
            if (token2 && token2.isUnclosed) {
              obj.isUnclosed = token2.isUnclosed;
            }
      ...
      _.each(errors, function(desc, code) {
        exports2.errors[code] = { code, desc };
      });
      _.each(warnings, function(desc, code) {
        exports2.warnings[code] = { code, desc };
      });
      _.each(info, function(desc, code) {
        exports2.info[code] = { code, desc };
      });
    }, { "underscore": "/../../../jshint/node_modules/underscore/underscore-umd.js" }], "/../../../jshint/src/name-stack.js": [function(_dereq_, module2, exports2) {
      function NameStack() {
        this._stack = [];
      }
      ...
      module2.exports = NameStack;
    }, {}], "/../../../jshint/src/options.js": [function(_dereq_, module2, exports2) {
      exports2.bool = {
        enforcing: {
          bitwise: true,
          freeze: true,
      ...
      exports2.validNames = Object.keys(exports2.val).concat(Object.keys(exports2.bool.relaxing)).concat(Object.keys(exports2.bool.enforcing)).concat(Object.keys(exports2.bool.obsolete)).concat(Object.keys(exports2.bool.environments)).concat(["unstable"]);
      exports2.unstableNames = Object.keys(exports2.unstable);
      exports2.renamed = {
        eqeq: "eqeqeq",
        windows: "wsh",
        sloppy: "strict"
      ...
      exports2.noenforceall = {
        varstmt: true,
        strict: true,
        regexpu: true
      };
    }, {}], "/../../../jshint/src/prod-params.js": [function(_dereq_, module2, exports2) {
      module2.exports = {
        export: 1,
        noin: 2,
        initial: 4,
    ...
    }, {}], "/../../../jshint/src/reg.js": [function(_dereq_, module2, exports2) {
      exports2.unsafeString = /@cc|<\/?|script|\]\s*\]|<\s*!|&lt/i;
      exports2.needEsc = /[\u0000-\u001f&<"\/\\\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/;
      exports2.needEscGlobal = /[\u0000-\u001f&<"\/\\\u007f-\u009f\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g;
      exports2.starSlash = /\*\//;
      exports2.identifier = /^([a-zA-Z_$][a-zA-Z0-9_$]*)$/;
      exports2.javascriptURL = /^(?:javascript|jscript|ecmascript|vbscript|livescript)\s*:/i;
      exports2.fallsThrough = /^\s*falls?\sthrough\s*$/;
      exports2.maxlenException = /^(?:(?:\/\/|\/\*|\*) ?)?[^ ]+$/;
      exports2.whitespace = /[ \f\n\r\t\v\u00a0\u1680\u2000-\u200a\u2028\u2029\u202f\u205f\u3000\ufeff]/;
      exports2.nonzeroDigit = /^[1-9]$/;
      exports2.decimalDigit = /^[0-9]$/;
      exports2.regexpSyntaxChars = /[\^$\\.*+?()[\]{}|]/;
      exports2.regexpQuantifiers = /[*+?{]/;
      exports2.regexpControlEscapes = /[fnrtv]/;
      exports2.regexpCharClasses = /[dDsSwWpP]/;
      exports2.regexpDot = /(^|[^\\])(\\\\)*\./;
    }, {}], "/../../../jshint/src/scope-manager.js": [function(_dereq_, module2, exports2) {
      var _ = _dereq_("underscore");
      ...
      var scopeManager = function(state, predefined, exported, declared) {
        ...
        function _newScope(type) {
          _current = {
            "(bindings)": /* @__PURE__ */ Object.create(null),
            "(usages)": /* @__PURE__ */ Object.create(null),
            "(labels)": /* @__PURE__ */ Object.create(null),
            "(parent)": _current,
            "(type)": type,
        ...
        var usedPredefinedAndGlobals = /* @__PURE__ */ Object.create(null);
        var impliedGlobals = /* @__PURE__ */ Object.create(null);
        var unuseds = [];
        var esModuleExports = [];
        ...
        var _warnUnused = function(name, tkn, type, unused_opt) {
          ...
          if (unused_opt) {
            if (warnable_types[unused_opt] && warnable_types[unused_opt].indexOf(type) !== -1) {
              warning("W098", { line, from: chr }, raw_name);
            }
          }
        ...
        function _checkForUnused() {
          if (_current["(type)"] !== "functionparams") {
            ...
            for (var bindingName in currentBindings) {
              if (currentBindings[bindingName]["(type)"] !== "exception" && currentBindings[bindingName]["(unused)"]) {
        ...
        var scopeManagerInst = {
          ...
          unstack: function() {
            ...
            for (i = 0; i < usedBindingNameList.length; i++) {
              ...
              if (usedBinding) {
                ...
                isFunction = usedBindingType === "function" || usedBindingType === "generator function" || usedBindingType === "async function";
              ...
              if (subScope) {
                ...
                isImmutable = bindingType === "const" || bindingType === null && _scopeStack[0]["(predefined)"][usedBindingName] === false;
              ...
              for (i = 0; i < bindingNames.length; i++) {
                ...
                if (!defBinding["(blockscoped)"] && defBinding["(type)"] !== "exception") {
                  ...
                  if (shadowed) {
                    ...
                    defBinding["(useOutsideOfScope)"] = _currentFunctBody["(type)"] !== "global" && !this.funct.has(defBindingName, { excludeCurrent: true });
          ...
          addExported: function(bindingName) {
            ...
            if (_.has(declared, bindingName)) {
              ...
              for (var i = 1; i < _scopeStack.length; i++) {
                ...
                if (!scope["(type)"]) {
                  if (_.has(scope["(bindings)"], bindingName) && !scope["(bindings)"][bindingName]["(blockscoped)"]) {
          ...
          addbinding: function(bindingName, opts) {
            ...
            var isexported = (isblockscoped ? _current : _currentFunctBody)["(type)"] === "global" && _.has(exported, bindingName);
            _checkOuterShadow(bindingName, token);
            if (state.isStrict() && (bindingName === "arguments" || bindingName === "eval")) {
              warning("E008", token);
            }
          ...
          funct: {
            bindingtype: function(bindingName, options) {
              ...
              for (var i = currentScopeIndex; i >= 0; i--) {
                var current = _scopeStack[i];
                if (current["(bindings)"][bindingName] && (!onlyBlockscoped || current["(bindings)"][bindingName]["(blockscoped)"])) {
          ...
          block: {
            ...
            use: function(bindingName, token) {
              ...
              if (paramScope && paramScope["(bindings)"][bindingName] && paramScope["(bindings)"][bindingName]["(type)"] === "param") {
                if (!scopeManagerInst.funct.has(
                  bindingName,
    ...
    }, { "events": "/node_modules/events/events.js", "lodash.slice": "/../../../jshint/node_modules/lodash.slice/index.js", "underscore": "/../../../jshint/node_modules/underscore/underscore-umd.js" }], "/../../../jshint/src/state.js": [function(_dereq_, module2, exports2) {
      ...
      var state = {
        ...
        reset: function() {
          ...
          this.funct = null;
          this.ignored = {};
          this.directive = /* @__PURE__ */ Object.create(null);
          this.jsonMode = false;
          this.lines = [];
          this.tab = "";
          this.cache = {};
    ...
    }, { "./name-stack.js": "/../../../jshint/src/name-stack.js" }], "/../../../jshint/src/style.js": [function(_dereq_, module2, exports2) {
      exports2.register = function(linter) {
    ...
    }, {}], "/../../../jshint/src/validate-unicode-escape-sequence.js": [function(_dereq_, module2, exports2) {
      module2.exports = function validate(sequence) {
      ...
      var names = {
        nonBinary: /* @__PURE__ */ Object.create(null),
        binary: /* @__PURE__ */ Object.create(null)
      };
      var values = {
        general: /* @__PURE__ */ Object.create(null),
        script: /* @__PURE__ */ Object.create(null)
      };
      ...
      s.Zanb = true;
    }, {}], "/../../../jshint/src/vars.js": [function(_dereq_, module2, exports2) {
      exports2.reservedVars = {
        NaN: false,
        undefined: false
      };
      exports2.ecmaIdentifiers = {
        3: {
          Array: false,
          Boolean: false,
          Date: false,
    ...
    }, {}], "/node_modules/assert/assert.js": [function(_dereq_, module2, exports2) {
      var util = _dereq_("util/");
    ...
    }, { "util/": "/node_modules/assert/node_modules/util/util.js" }], "/node_modules/assert/node_modules/inherits/inherits_browser.js": [function(_dereq_, module2, exports2) {
    ...
    }, {}], "/node_modules/assert/node_modules/util/support/isBufferBrowser.js": [function(_dereq_, module2, exports2) {
      module2.exports = function isBuffer(arg) {
        return arg && typeof arg === "object" && typeof arg.copy === "function" && typeof arg.fill === "function" && typeof arg.readUInt8 === "function";
      };
    }, {}], "/node_modules/assert/node_modules/util/util.js": [function(_dereq_, module2, exports2) {
      ...
      }).call(this, _dereq_("_process"), typeof commonjsGlobal !== "undefined" ? commonjsGlobal : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {});
    }, { "./support/isBuffer": "/node_modules/assert/node_modules/util/support/isBufferBrowser.js", "_process": "/node_modules/process/browser.js", "inherits": "/node_modules/assert/node_modules/inherits/inherits_browser.js" }], "/node_modules/events/events.js": [function(_dereq_, module2, exports2) {
    ...
    }, {}], "/node_modules/process/browser.js": [function(_dereq_, module2, exports2) {
    ...
    }, {}], "/node_modules/util/node_modules/inherits/inherits_browser.js": [function(_dereq_, module2, exports2) {
      arguments[4]["/node_modules/assert/node_modules/inherits/inherits_browser.js"][0].apply(exports2, arguments);
    }, {}], "/node_modules/util/support/isBufferBrowser.js": [function(_dereq_, module2, exports2) {
      arguments[4]["/node_modules/assert/node_modules/util/support/isBufferBrowser.js"][0].apply(exports2, arguments);
    }, {}], "/node_modules/util/util.js": [function(_dereq_, module2, exports2) {
      arguments[4]["/node_modules/assert/node_modules/util/util.js"][0].apply(exports2, arguments);
  ...
  ace.define("ace/mode/javascript_worker", [], function(require2, exports, module) {
    var oop = require2("../lib/oop");
    var Mirror = require2("../worker/mirror").Mirror;
    var lint = require2("./javascript/jshint").JSHINT;
  ...
  return workerJavascript$2;
}
var workerJavascriptExports = requireWorkerJavascript();
const workerJavascript = /* @__PURE__ */ getDefaultExportFromCjs(workerJavascriptExports);
const workerJavascript$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: workerJavascript
}, [workerJavascriptExports]);
export {
  workerJavascript$1 as w
};
