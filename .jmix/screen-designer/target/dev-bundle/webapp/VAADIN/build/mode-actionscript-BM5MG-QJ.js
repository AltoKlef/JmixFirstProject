...
var modeActionscript$2 = { exports: {} };
var hasRequiredModeActionscript;
function requireModeActionscript() {
  if (hasRequiredModeActionscript) return modeActionscript$2.exports;
  hasRequiredModeActionscript = 1;
  (function(module, exports) {
    ace.define("ace/mode/actionscript_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.ActionScriptHighlightRules = ActionScriptHighlightRules;
    });
    ...
    ace.define("ace/mode/actionscript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/actionscript_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var ActionScriptHighlightRules = require2("./actionscript_highlight_rules").ActionScriptHighlightRules;
  ...
  return modeActionscript$2.exports;
}
var modeActionscriptExports = requireModeActionscript();
const modeActionscript = /* @__PURE__ */ getDefaultExportFromCjs(modeActionscriptExports);
const modeActionscript$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeActionscript
}, [modeActionscriptExports]);
export {
  modeActionscript$1 as m
};
