...
var modeIo$2 = { exports: {} };
var hasRequiredModeIo;
function requireModeIo() {
  if (hasRequiredModeIo) return modeIo$2.exports;
  hasRequiredModeIo = 1;
  (function(module, exports) {
    ace.define("ace/mode/io_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.IoHighlightRules = IoHighlightRules;
    });
    ...
    ace.define("ace/mode/io", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/io_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var IoHighlightRules = require2("./io_highlight_rules").IoHighlightRules;
  ...
  return modeIo$2.exports;
}
var modeIoExports = requireModeIo();
const modeIo = /* @__PURE__ */ getDefaultExportFromCjs(modeIoExports);
const modeIo$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeIo
}, [modeIoExports]);
export {
