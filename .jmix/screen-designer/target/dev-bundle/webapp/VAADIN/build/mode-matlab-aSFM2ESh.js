...
var modeMatlab$2 = { exports: {} };
var hasRequiredModeMatlab;
function requireModeMatlab() {
  if (hasRequiredModeMatlab) return modeMatlab$2.exports;
  hasRequiredModeMatlab = 1;
  (function(module, exports) {
    ace.define("ace/mode/matlab_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.MatlabHighlightRules = MatlabHighlightRules;
    });
    ace.define("ace/mode/matlab", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/matlab_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var MatlabHighlightRules = require2("./matlab_highlight_rules").MatlabHighlightRules;
      var Mode = function() {
  ...
  return modeMatlab$2.exports;
}
var modeMatlabExports = requireModeMatlab();
const modeMatlab = /* @__PURE__ */ getDefaultExportFromCjs(modeMatlabExports);
const modeMatlab$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeMatlab
}, [modeMatlabExports]);
export {
