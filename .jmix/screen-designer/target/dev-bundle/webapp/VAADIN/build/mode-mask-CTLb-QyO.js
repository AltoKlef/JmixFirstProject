...
var modeMask$2 = { exports: {} };
var hasRequiredModeMask;
function requireModeMask() {
  if (hasRequiredModeMask) return modeMask$2.exports;
  hasRequiredModeMask = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/mask_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/lib/lang", "ace/mode/text_highlight_rules", "ace/mode/javascript_highlight_rules", "ace/mode/css_highlight_rules", "ace/mode/markdown_highlight_rules", "ace/mode/html_highlight_rules"], function(require2, exports2, module2) {
      exports2.MaskHighlightRules = MaskHighlightRules;
      var oop = require2("../lib/oop");
      var lang = require2("../lib/lang");
      var TextRules = require2("./text_highlight_rules").TextHighlightRules;
      var JSRules = require2("./javascript_highlight_rules").JavaScriptHighlightRules;
      var CssRules = require2("./css_highlight_rules").CssHighlightRules;
      var MDRules = require2("./markdown_highlight_rules").MarkdownHighlightRules;
      var HTMLRules = require2("./html_highlight_rules").HtmlHighlightRules;
    ...
    ace.define("ace/mode/mask", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mask_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/css", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var MaskHighlightRules = require2("./mask_highlight_rules").MaskHighlightRules;
  ...
  return modeMask$2.exports;
}
var modeMaskExports = requireModeMask();
const modeMask = /* @__PURE__ */ getDefaultExportFromCjs(modeMaskExports);
const modeMask$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeMask
}, [modeMaskExports]);
export {
