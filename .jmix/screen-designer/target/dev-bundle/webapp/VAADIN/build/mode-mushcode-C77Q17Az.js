...
var modeMushcode$2 = { exports: {} };
var hasRequiredModeMushcode;
function requireModeMushcode() {
  if (hasRequiredModeMushcode) return modeMushcode$2.exports;
  hasRequiredModeMushcode = 1;
  (function(module, exports) {
    ace.define("ace/mode/mushcode_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.MushCodeRules = MushCodeRules;
    });
    ...
    ace.define("ace/mode/mushcode", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mushcode_highlight_rules", "ace/mode/folding/pythonic", "ace/range"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var MushCodeRules = require2("./mushcode_highlight_rules").MushCodeRules;
  ...
  return modeMushcode$2.exports;
}
var modeMushcodeExports = requireModeMushcode();
const modeMushcode = /* @__PURE__ */ getDefaultExportFromCjs(modeMushcodeExports);
const modeMushcode$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeMushcode
}, [modeMushcodeExports]);
export {
  modeMushcode$1 as m
};
