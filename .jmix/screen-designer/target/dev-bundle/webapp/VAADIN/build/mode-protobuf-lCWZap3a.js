...
var modeProtobuf$2 = { exports: {} };
var hasRequiredModeProtobuf;
function requireModeProtobuf() {
  if (hasRequiredModeProtobuf) return modeProtobuf$2.exports;
  hasRequiredModeProtobuf = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/c_cpp", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/c_cpp_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
    ...
    ace.define("ace/mode/protobuf_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.ProtobufHighlightRules = ProtobufHighlightRules;
    });
    ace.define("ace/mode/protobuf", ["require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp", "ace/mode/protobuf_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var CMode = require2("./c_cpp").Mode;
      var ProtobufHighlightRules = require2("./protobuf_highlight_rules").ProtobufHighlightRules;
      var CStyleFoldMode = require2("./folding/cstyle").FoldMode;
      var Mode = function() {
        CMode.call(this);
        this.foldingRules = new CStyleFoldMode();
  ...
  return modeProtobuf$2.exports;
}
var modeProtobufExports = requireModeProtobuf();
const modeProtobuf = /* @__PURE__ */ getDefaultExportFromCjs(modeProtobufExports);
const modeProtobuf$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeProtobuf
}, [modeProtobufExports]);
export {
  modeProtobuf$1 as m
};
