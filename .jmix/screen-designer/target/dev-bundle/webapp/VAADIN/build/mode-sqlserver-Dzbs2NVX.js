...
var modeSqlserver$2 = { exports: {} };
var hasRequiredModeSqlserver;
function requireModeSqlserver() {
  if (hasRequiredModeSqlserver) return modeSqlserver$2.exports;
  hasRequiredModeSqlserver = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/sqlserver_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
        ...
        this.$rules = {
          start: [
            ...
            },
            {
              ...
              //up to 2 @symbols for some built in functions
            },
            {
      ...
      exports2.SqlHighlightRules = SqlServerHighlightRules;
    });
    ...
    ace.define("ace/mode/folding/sqlserver", ["require", "exports", "module", "ace/lib/oop", "ace/range", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../../lib/oop");
      var Range = require2("../../range").Range;
    ...
    ace.define("ace/mode/sqlserver", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/sqlserver_highlight_rules", "ace/mode/folding/sqlserver"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var SqlServerHighlightRules = require2("./sqlserver_highlight_rules").SqlHighlightRules;
      var SqlServerFoldMode = require2("./folding/sqlserver").FoldMode;
      var Mode = function() {
  ...
  return modeSqlserver$2.exports;
}
var modeSqlserverExports = requireModeSqlserver();
const modeSqlserver = /* @__PURE__ */ getDefaultExportFromCjs(modeSqlserverExports);
const modeSqlserver$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeSqlserver
}, [modeSqlserverExports]);
export {
  modeSqlserver$1 as m
};
