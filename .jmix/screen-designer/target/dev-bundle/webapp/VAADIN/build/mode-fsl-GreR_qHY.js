...
var modeFsl$2 = { exports: {} };
var hasRequiredModeFsl;
function requireModeFsl() {
  if (hasRequiredModeFsl) return modeFsl$2.exports;
  hasRequiredModeFsl = 1;
  (function(module, exports) {
    ace.define("ace/mode/fsl_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.FSLHighlightRules = FSLHighlightRules;
    });
    ...
    ace.define("ace/mode/fsl", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/fsl_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var FSLHighlightRules = require2("./fsl_highlight_rules").FSLHighlightRules;
  ...
  return modeFsl$2.exports;
}
var modeFslExports = requireModeFsl();
const modeFsl = /* @__PURE__ */ getDefaultExportFromCjs(modeFslExports);
const modeFsl$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeFsl
}, [modeFslExports]);
export {
