...
var modeApplescript$2 = { exports: {} };
var hasRequiredModeApplescript;
function requireModeApplescript() {
  if (hasRequiredModeApplescript) return modeApplescript$2.exports;
  hasRequiredModeApplescript = 1;
  (function(module, exports) {
    ace.define("ace/mode/applescript_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.AppleScriptHighlightRules = AppleScriptHighlightRules;
    });
    ...
    ace.define("ace/mode/applescript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/applescript_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var AppleScriptHighlightRules = require2("./applescript_highlight_rules").AppleScriptHighlightRules;
  ...
  return modeApplescript$2.exports;
}
var modeApplescriptExports = requireModeApplescript();
const modeApplescript = /* @__PURE__ */ getDefaultExportFromCjs(modeApplescriptExports);
const modeApplescript$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeApplescript
}, [modeApplescriptExports]);
export {
  modeApplescript$1 as m
};
