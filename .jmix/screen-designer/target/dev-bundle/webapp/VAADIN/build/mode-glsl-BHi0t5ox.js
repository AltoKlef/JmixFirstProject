...
var modeGlsl$2 = { exports: {} };
var hasRequiredModeGlsl;
function requireModeGlsl() {
  if (hasRequiredModeGlsl) return modeGlsl$2.exports;
  hasRequiredModeGlsl = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/glsl_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var c_cppHighlightRules = require2("./c_cpp_highlight_rules").c_cppHighlightRules;
      ...
      exports2.glslHighlightRules = glslHighlightRules;
    });
    ace.define("ace/mode/glsl", ["require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp", "ace/mode/glsl_highlight_rules", "ace/mode/matching_brace_outdent", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var CMode = require2("./c_cpp").Mode;
      var glslHighlightRules = require2("./glsl_highlight_rules").glslHighlightRules;
      var MatchingBraceOutdent = require2("./matching_brace_outdent").MatchingBraceOutdent;
      require2("../range").Range;
      var CstyleBehaviour = require2("./behaviour/cstyle").CstyleBehaviour;
      var CStyleFoldMode = require2("./folding/cstyle").FoldMode;
  ...
  return modeGlsl$2.exports;
}
var modeGlslExports = requireModeGlsl();
const modeGlsl = /* @__PURE__ */ getDefaultExportFromCjs(modeGlslExports);
const modeGlsl$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeGlsl
}, [modeGlslExports]);
export {
