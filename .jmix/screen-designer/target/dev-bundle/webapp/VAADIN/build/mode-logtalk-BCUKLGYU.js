...
var modeLogtalk$2 = { exports: {} };
var hasRequiredModeLogtalk;
function requireModeLogtalk() {
  if (hasRequiredModeLogtalk) return modeLogtalk$2.exports;
  hasRequiredModeLogtalk = 1;
  (function(module, exports) {
    ace.define("ace/mode/logtalk_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.LogtalkHighlightRules = LogtalkHighlightRules;
    });
    ...
    ace.define("ace/mode/logtalk", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/tokenizer", "ace/mode/logtalk_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      require2("../tokenizer").Tokenizer;
      var LogtalkHighlightRules = require2("./logtalk_highlight_rules").LogtalkHighlightRules;
  ...
  return modeLogtalk$2.exports;
}
var modeLogtalkExports = requireModeLogtalk();
const modeLogtalk = /* @__PURE__ */ getDefaultExportFromCjs(modeLogtalkExports);
const modeLogtalk$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeLogtalk
}, [modeLogtalkExports]);
export {
