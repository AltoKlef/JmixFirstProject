...
var modeNginx$2 = { exports: {} };
var hasRequiredModeNginx;
function requireModeNginx() {
  if (hasRequiredModeNginx) return modeNginx$2.exports;
  hasRequiredModeNginx = 1;
  (function(module, exports) {
    ace.define("ace/mode/nginx_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.NginxHighlightRules = NginxHighlightRules;
    });
    ...
    ace.define("ace/mode/nginx", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/nginx_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var NginxHighlightRules = require2("./nginx_highlight_rules").NginxHighlightRules;
  ...
  return modeNginx$2.exports;
}
var modeNginxExports = requireModeNginx();
const modeNginx = /* @__PURE__ */ getDefaultExportFromCjs(modeNginxExports);
const modeNginx$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeNginx
}, [modeNginxExports]);
export {
