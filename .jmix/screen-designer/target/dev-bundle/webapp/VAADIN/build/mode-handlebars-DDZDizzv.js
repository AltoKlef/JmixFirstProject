...
var modeHandlebars$2 = { exports: {} };
var hasRequiredModeHandlebars;
function requireModeHandlebars() {
  if (hasRequiredModeHandlebars) return modeHandlebars$2.exports;
  hasRequiredModeHandlebars = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/handlebars_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlHighlightRules = require2("./html_highlight_rules").HtmlHighlightRules;
      ...
      exports2.HandlebarsHighlightRules = HandlebarsHighlightRules;
    });
    ace.define("ace/mode/behaviour/html", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour/xml"], function(require2, exports2, module2) {
      var oop = require2("../../lib/oop");
      var XmlBehaviour = require2("../behaviour/xml").XmlBehaviour;
      ...
      exports2.HtmlBehaviour = HtmlBehaviour;
    });
    ace.define("ace/mode/handlebars", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/handlebars_highlight_rules", "ace/mode/behaviour/html", "ace/mode/folding/html"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlMode = require2("./html").Mode;
      var HandlebarsHighlightRules = require2("./handlebars_highlight_rules").HandlebarsHighlightRules;
      var HtmlBehaviour = require2("./behaviour/html").HtmlBehaviour;
      require2("./folding/html").FoldMode;
      var Mode = function() {
        HtmlMode.call(this);
  ...
  return modeHandlebars$2.exports;
}
var modeHandlebarsExports = requireModeHandlebars();
const modeHandlebars = /* @__PURE__ */ getDefaultExportFromCjs(modeHandlebarsExports);
const modeHandlebars$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeHandlebars
}, [modeHandlebarsExports]);
export {
  modeHandlebars$1 as m
};
