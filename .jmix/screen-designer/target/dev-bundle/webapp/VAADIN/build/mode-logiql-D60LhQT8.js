...
var modeLogiql$2 = { exports: {} };
var hasRequiredModeLogiql;
function requireModeLogiql() {
  if (hasRequiredModeLogiql) return modeLogiql$2.exports;
  hasRequiredModeLogiql = 1;
  (function(module, exports) {
    ace.define("ace/mode/logiql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.LogiQLHighlightRules = LogiQLHighlightRules;
    });
    ...
    ace.define("ace/mode/logiql", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/logiql_highlight_rules", "ace/mode/folding/coffee", "ace/token_iterator", "ace/range", "ace/mode/behaviour/cstyle", "ace/mode/matching_brace_outdent"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var LogiQLHighlightRules = require2("./logiql_highlight_rules").LogiQLHighlightRules;
  ...
  return modeLogiql$2.exports;
}
var modeLogiqlExports = requireModeLogiql();
const modeLogiql = /* @__PURE__ */ getDefaultExportFromCjs(modeLogiqlExports);
const modeLogiql$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeLogiql
}, [modeLogiqlExports]);
export {
