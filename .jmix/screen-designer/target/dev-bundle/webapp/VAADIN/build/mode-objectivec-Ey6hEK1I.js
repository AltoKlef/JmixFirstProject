...
var modeObjectivec$2 = { exports: {} };
var hasRequiredModeObjectivec;
function requireModeObjectivec() {
  if (hasRequiredModeObjectivec) return modeObjectivec$2.exports;
  hasRequiredModeObjectivec = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/objectivec_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/c_cpp_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var DocCommentHighlightRules = require2("./doc_comment_highlight_rules").DocCommentHighlightRules;
      var C_Highlight_File = require2("./c_cpp_highlight_rules");
      ...
      exports2.ObjectiveCHighlightRules = ObjectiveCHighlightRules;
    });
    ...
    ace.define("ace/mode/objectivec", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/objectivec_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var ObjectiveCHighlightRules = require2("./objectivec_highlight_rules").ObjectiveCHighlightRules;
  ...
  return modeObjectivec$2.exports;
}
var modeObjectivecExports = requireModeObjectivec();
const modeObjectivec = /* @__PURE__ */ getDefaultExportFromCjs(modeObjectivecExports);
const modeObjectivec$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeObjectivec
}, [modeObjectivecExports]);
export {
  modeObjectivec$1 as m
};
