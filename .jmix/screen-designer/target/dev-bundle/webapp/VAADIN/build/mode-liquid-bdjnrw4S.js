...
var modeLiquid$2 = { exports: {} };
var hasRequiredModeLiquid;
function requireModeLiquid() {
  if (hasRequiredModeLiquid) return modeLiquid$2.exports;
  hasRequiredModeLiquid = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/liquid_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/css_highlight_rules", "ace/mode/html_highlight_rules", "ace/mode/json_highlight_rules", "ace/mode/javascript_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var CssHighlightRules = require2("./css_highlight_rules").CssHighlightRules;
      var HtmlHighlightRules = require2("./html_highlight_rules").HtmlHighlightRules;
      ...
      exports2.LiquidHighlightRules = LiquidHighlightRules;
    });
    ace.define("ace/mode/liquid", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/html", "ace/mode/javascript", "ace/mode/json", "ace/mode/css", "ace/mode/liquid_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var HtmlMode = require2("./html").Mode;
      var JavascriptMode = require2("./javascript").Mode;
      var JsonMode = require2("./json").Mode;
      var CssMode = require2("./css").Mode;
      var LiquidHighlightRules = require2("./liquid_highlight_rules").LiquidHighlightRules;
      require2("./matching_brace_outdent").MatchingBraceOutdent;
  ...
  return modeLiquid$2.exports;
}
var modeLiquidExports = requireModeLiquid();
const modeLiquid = /* @__PURE__ */ getDefaultExportFromCjs(modeLiquidExports);
const modeLiquid$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeLiquid
}, [modeLiquidExports]);
export {
