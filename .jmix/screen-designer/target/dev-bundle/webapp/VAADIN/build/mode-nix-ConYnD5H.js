...
var modeNix$2 = { exports: {} };
var hasRequiredModeNix;
function requireModeNix() {
  if (hasRequiredModeNix) return modeNix$2.exports;
  hasRequiredModeNix = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/nix_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.NixHighlightRules = NixHighlightRules;
    });
    ace.define("ace/mode/nix", ["require", "exports", "module", "ace/lib/oop", "ace/mode/c_cpp", "ace/mode/nix_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var CMode = require2("./c_cpp").Mode;
      var NixHighlightRules = require2("./nix_highlight_rules").NixHighlightRules;
      var CStyleFoldMode = require2("./folding/cstyle").FoldMode;
      var Mode = function() {
        CMode.call(this);
  ...
  return modeNix$2.exports;
}
var modeNixExports = requireModeNix();
const modeNix = /* @__PURE__ */ getDefaultExportFromCjs(modeNixExports);
const modeNix$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeNix
}, [modeNixExports]);
export {
