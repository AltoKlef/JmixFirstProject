...
var modeAsl$2 = { exports: {} };
var hasRequiredModeAsl;
function requireModeAsl() {
  if (hasRequiredModeAsl) return modeAsl$2.exports;
  hasRequiredModeAsl = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/asl_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      ...
      exports2.ASLHighlightRules = ASLHighlightRules;
    });
    ...
    ace.define("ace/mode/asl", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/asl_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var ASLHighlightRules = require2("./asl_highlight_rules").ASLHighlightRules;
  ...
  return modeAsl$2.exports;
}
var modeAslExports = requireModeAsl();
const modeAsl = /* @__PURE__ */ getDefaultExportFromCjs(modeAslExports);
const modeAsl$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeAsl
}, [modeAslExports]);
export {
