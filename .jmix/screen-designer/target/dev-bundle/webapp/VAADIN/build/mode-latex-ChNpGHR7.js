...
var modeLatex$2 = { exports: {} };
var hasRequiredModeLatex;
function requireModeLatex() {
  if (hasRequiredModeLatex) return modeLatex$2.exports;
  hasRequiredModeLatex = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/folding/latex", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range", "ace/token_iterator"], function(require2, exports2, module2) {
      var oop = require2("../../lib/oop");
    ...
    ace.define("ace/mode/latex", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/latex_highlight_rules", "ace/mode/behaviour/cstyle", "ace/mode/folding/latex"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var LatexHighlightRules = require2("./latex_highlight_rules").LatexHighlightRules;
      var CstyleBehaviour = require2("./behaviour/cstyle").CstyleBehaviour;
      var LatexFoldMode = require2("./folding/latex").FoldMode;
      var Mode = function() {
  ...
  return modeLatex$2.exports;
}
var modeLatexExports = requireModeLatex();
const modeLatex = /* @__PURE__ */ getDefaultExportFromCjs(modeLatexExports);
const modeLatex$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeLatex
}, [modeLatexExports]);
export {
