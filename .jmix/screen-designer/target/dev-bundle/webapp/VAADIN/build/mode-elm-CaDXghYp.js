...
var modeElm$2 = { exports: {} };
var hasRequiredModeElm;
function requireModeElm() {
  if (hasRequiredModeElm) return modeElm$2.exports;
  hasRequiredModeElm = 1;
  (function(module, exports) {
    ace.define("ace/mode/elm_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.ElmHighlightRules = ElmHighlightRules;
    });
    ...
    ace.define("ace/mode/elm", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/elm_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var HighlightRules = require2("./elm_highlight_rules").ElmHighlightRules;
  ...
  return modeElm$2.exports;
}
var modeElmExports = requireModeElm();
const modeElm = /* @__PURE__ */ getDefaultExportFromCjs(modeElmExports);
const modeElm$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeElm
}, [modeElmExports]);
export {
