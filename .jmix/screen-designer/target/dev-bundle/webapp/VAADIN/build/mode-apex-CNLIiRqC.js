...
var modeApex$2 = { exports: {} };
var hasRequiredModeApex;
function requireModeApex() {
  if (hasRequiredModeApex) return modeApex$2.exports;
  hasRequiredModeApex = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/apex_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/doc_comment_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("../mode/text_highlight_rules").TextHighlightRules;
      var DocCommentHighlightRules = require2("../mode/doc_comment_highlight_rules").DocCommentHighlightRules;
      ...
      exports2.ApexHighlightRules = ApexHighlightRules;
    });
    ...
    ace.define("ace/mode/apex", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/apex_highlight_rules", "ace/mode/folding/cstyle", "ace/mode/behaviour/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("../mode/text").Mode;
      var ApexHighlightRules = require2("./apex_highlight_rules").ApexHighlightRules;
      var FoldMode = require2("../mode/folding/cstyle").FoldMode;
      var CstyleBehaviour = require2("../mode/behaviour/cstyle").CstyleBehaviour;
      function ApexMode() {
        TextMode.call(this);
  ...
  return modeApex$2.exports;
}
var modeApexExports = requireModeApex();
const modeApex = /* @__PURE__ */ getDefaultExportFromCjs(modeApexExports);
const modeApex$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeApex
}, [modeApexExports]);
export {
