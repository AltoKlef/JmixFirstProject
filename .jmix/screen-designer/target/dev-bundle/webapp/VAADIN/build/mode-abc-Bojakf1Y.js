...
var modeAbc$2 = { exports: {} };
var hasRequiredModeAbc;
function requireModeAbc() {
  if (hasRequiredModeAbc) return modeAbc$2.exports;
  hasRequiredModeAbc = 1;
  (function(module, exports) {
    ace.define("ace/mode/abc_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.ABCHighlightRules = ABCHighlightRules;
    });
    ...
    ace.define("ace/mode/abc", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/abc_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var ABCHighlightRules = require2("./abc_highlight_rules").ABCHighlightRules;
  ...
  return modeAbc$2.exports;
}
var modeAbcExports = requireModeAbc();
const modeAbc = /* @__PURE__ */ getDefaultExportFromCjs(modeAbcExports);
const modeAbc$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeAbc
}, [modeAbcExports]);
export {
