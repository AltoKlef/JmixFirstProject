...
var modeVbscript$2 = { exports: {} };
var hasRequiredModeVbscript;
function requireModeVbscript() {
  if (hasRequiredModeVbscript) return modeVbscript$2.exports;
  hasRequiredModeVbscript = 1;
  (function(module, exports) {
    ace.define("ace/mode/vbscript_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.VBScriptHighlightRules = VBScriptHighlightRules;
    });
    ace.define("ace/mode/folding/vbscript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range", "ace/token_iterator"], function(require2, exports2, module2) {
      var oop = require2("../../lib/oop");
    ...
    ace.define("ace/mode/vbscript", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/vbscript_highlight_rules", "ace/mode/folding/vbscript", "ace/range"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var VBScriptHighlightRules = require2("./vbscript_highlight_rules").VBScriptHighlightRules;
      var FoldMode = require2("./folding/vbscript").FoldMode;
      var Range = require2("../range").Range;
      var Mode = function() {
  ...
  return modeVbscript$2.exports;
}
var modeVbscriptExports = requireModeVbscript();
const modeVbscript = /* @__PURE__ */ getDefaultExportFromCjs(modeVbscriptExports);
const modeVbscript$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeVbscript
}, [modeVbscriptExports]);
export {
  modeVbscript$1 as m
};
