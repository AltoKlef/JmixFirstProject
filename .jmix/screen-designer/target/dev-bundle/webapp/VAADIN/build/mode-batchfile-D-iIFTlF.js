...
var modeBatchfile$2 = { exports: {} };
var hasRequiredModeBatchfile;
function requireModeBatchfile() {
  if (hasRequiredModeBatchfile) return modeBatchfile$2.exports;
  hasRequiredModeBatchfile = 1;
  (function(module, exports) {
    ace.define("ace/mode/batchfile_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.BatchFileHighlightRules = BatchFileHighlightRules;
    });
    ...
    ace.define("ace/mode/batchfile", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/batchfile_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var BatchFileHighlightRules = require2("./batchfile_highlight_rules").BatchFileHighlightRules;
  ...
  return modeBatchfile$2.exports;
}
var modeBatchfileExports = requireModeBatchfile();
const modeBatchfile = /* @__PURE__ */ getDefaultExportFromCjs(modeBatchfileExports);
const modeBatchfile$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeBatchfile
}, [modeBatchfileExports]);
export {
  modeBatchfile$1 as m
};
