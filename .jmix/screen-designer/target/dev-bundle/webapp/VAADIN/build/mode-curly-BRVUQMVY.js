...
var modeCurly$2 = { exports: {} };
var hasRequiredModeCurly;
function requireModeCurly() {
  if (hasRequiredModeCurly) return modeCurly$2.exports;
  hasRequiredModeCurly = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/curly_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlHighlightRules = require2("./html_highlight_rules").HtmlHighlightRules;
      ...
      exports2.CurlyHighlightRules = CurlyHighlightRules;
    });
    ace.define("ace/mode/curly", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/matching_brace_outdent", "ace/mode/folding/html", "ace/mode/curly_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlMode = require2("./html").Mode;
      var MatchingBraceOutdent = require2("./matching_brace_outdent").MatchingBraceOutdent;
      var HtmlFoldMode = require2("./folding/html").FoldMode;
      var CurlyHighlightRules = require2("./curly_highlight_rules").CurlyHighlightRules;
      var Mode = function() {
        HtmlMode.call(this);
  ...
  return modeCurly$2.exports;
}
var modeCurlyExports = requireModeCurly();
const modeCurly = /* @__PURE__ */ getDefaultExportFromCjs(modeCurlyExports);
const modeCurly$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeCurly
}, [modeCurlyExports]);
export {
