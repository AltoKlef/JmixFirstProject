...
var modeXquery$2 = { exports: {} };
var hasRequiredModeXquery;
function requireModeXquery() {
  if (hasRequiredModeXquery) return modeXquery$2.exports;
  hasRequiredModeXquery = 1;
  (function(module, exports) {
    ace.define("ace/mode/xquery/xquery_lexer", ["require", "exports", "module"], function(require2, exports2, module2) {
      ...
      }({ "/node_modules/xqlint/lib/lexers/XQueryTokenizer.js": [function(_dereq_, module3, exports3) {
        var XQueryTokenizer = exports3.XQueryTokenizer = function XQueryTokenizer2(string, parsingEventHandler) {
          ...
          this.getOffendingToken = function(e) {
            ...
            return o >= 0 ? XQueryTokenizer2.TOKEN[o] : null;
          };
          this.getExpectedTokenSet = function(e) {
            var expected;
            if (e.getExpected() < 0) {
              expected = XQueryTokenizer2.getTokenSet(-e.getState());
            } else {
              expected = [XQueryTokenizer2.TOKEN[e.getExpected()]];
            }
            return expected;
          };
          ...
          function shift(t) {
            if (l1 == t) {
              whitespace();
              eventHandler.terminal(XQueryTokenizer2.TOKEN[l1], b1, e1 > size ? size : e1);
              b0 = b1;
              e0 = e1;
              l1 = 0;
            } else {
          ...
          function match(tokenSetId) {
            ...
            begin = end;
            var current = end;
            var result = XQueryTokenizer2.INITIAL[tokenSetId];
            var state = 0;
            for (var code = result & 4095; code != 0; ) {
              ...
              ++current;
              if (c0 < 128) {
                charclass = XQueryTokenizer2.MAP0[c0];
              } else if (c0 < 55296) {
                var c1 = c0 >> 4;
                charclass = XQueryTokenizer2.MAP1[(c0 & 15) + XQueryTokenizer2.MAP1[(c1 & 31) + XQueryTokenizer2.MAP1[c1 >> 5]]];
              } else {
                if (c0 < 56320) {
                ...
                for (var m = 3; ; m = hi + lo >> 1) {
                  if (XQueryTokenizer2.MAP2[m] > c0) hi = m - 1;
                  else if (XQueryTokenizer2.MAP2[6 + m] < c0) lo = m + 1;
                  else {
                    charclass = XQueryTokenizer2.MAP2[12 + m];
                    break;
                  }
                  if (lo > hi) {
                    charclass = 0;
              ...
              code = XQueryTokenizer2.TRANSITION[(i0 & 15) + XQueryTokenizer2.TRANSITION[i0 >> 4]];
              if (code > 4095) {
                result = code;
                code &= 4095;
                end = current;
      ...
      }, {}], "/node_modules/xqlint/lib/lexers/lexer.js": [function(_dereq_, module3, exports3) {
      ...
      }, {}], "/node_modules/xqlint/lib/lexers/xquery_lexer.js": [function(_dereq_, module3, exports3) {
    ...
    ace.define("ace/mode/xquery", ["require", "exports", "module", "ace/worker/worker_client", "ace/lib/oop", "ace/mode/text", "ace/mode/text_highlight_rules", "ace/mode/xquery/xquery_lexer", "ace/range", "ace/mode/behaviour/xquery", "ace/mode/folding/cstyle", "ace/anchor"], function(require2, exports2, module2) {
      ...
      var XQueryLexer = require2("./xquery/xquery_lexer").XQueryLexer;
      var Range = require2("../range").Range;
  ...
  return modeXquery$2.exports;
}
var modeXqueryExports = requireModeXquery();
const modeXquery = /* @__PURE__ */ getDefaultExportFromCjs(modeXqueryExports);
const modeXquery$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeXquery
}, [modeXqueryExports]);
export {
