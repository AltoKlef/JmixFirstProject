...
var modeTerraform$2 = { exports: {} };
var hasRequiredModeTerraform;
function requireModeTerraform() {
  if (hasRequiredModeTerraform) return modeTerraform$2.exports;
  hasRequiredModeTerraform = 1;
  (function(module, exports) {
    ace.define("ace/mode/terraform_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.TerraformHighlightRules = TerraformHighlightRules;
    });
    ...
    ace.define("ace/mode/terraform", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/terraform_highlight_rules", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle", "ace/mode/matching_brace_outdent"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var TerraformHighlightRules = require2("./terraform_highlight_rules").TerraformHighlightRules;
  ...
  return modeTerraform$2.exports;
}
var modeTerraformExports = requireModeTerraform();
const modeTerraform = /* @__PURE__ */ getDefaultExportFromCjs(modeTerraformExports);
const modeTerraform$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeTerraform
}, [modeTerraformExports]);
export {
  modeTerraform$1 as m
};
