...
var modeQml$2 = { exports: {} };
var hasRequiredModeQml;
function requireModeQml() {
  if (hasRequiredModeQml) return modeQml$2.exports;
  hasRequiredModeQml = 1;
  (function(module, exports) {
    ace.define("ace/mode/qml_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.QmlHighlightRules = QmlHighlightRules;
    });
    ...
    ace.define("ace/mode/qml", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/qml_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var QmlHighlightRules = require2("./qml_highlight_rules").QmlHighlightRules;
  ...
  return modeQml$2.exports;
}
var modeQmlExports = requireModeQml();
const modeQml = /* @__PURE__ */ getDefaultExportFromCjs(modeQmlExports);
const modeQml$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeQml
}, [modeQmlExports]);
export {
