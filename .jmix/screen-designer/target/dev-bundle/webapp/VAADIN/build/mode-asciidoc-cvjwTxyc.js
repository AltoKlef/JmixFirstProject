...
var modeAsciidoc$2 = { exports: {} };
var hasRequiredModeAsciidoc;
function requireModeAsciidoc() {
  if (hasRequiredModeAsciidoc) return modeAsciidoc$2.exports;
  hasRequiredModeAsciidoc = 1;
  (function(module, exports) {
    ace.define("ace/mode/asciidoc_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.AsciidocHighlightRules = AsciidocHighlightRules;
    });
    ace.define("ace/mode/folding/asciidoc", ["require", "exports", "module", "ace/lib/oop", "ace/mode/folding/fold_mode", "ace/range"], function(require2, exports2, module2) {
      var oop = require2("../../lib/oop");
      ...
      (function() {
        ...
        this.getFoldWidgetRange = function(session, foldStyle, row) {
          ...
          function getLevel() {
            ...
            var level2 = levels.indexOf(token.value[0]) + 1;
            if (level2 == 1) {
              if (session.getLine(row - 1).length != session.getLine(row).length)
                return Infinity;
            }
    ...
    ace.define("ace/mode/asciidoc", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/asciidoc_highlight_rules", "ace/mode/folding/asciidoc"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var AsciidocHighlightRules = require2("./asciidoc_highlight_rules").AsciidocHighlightRules;
      var AsciidocFoldMode = require2("./folding/asciidoc").FoldMode;
      var Mode = function() {
  ...
  return modeAsciidoc$2.exports;
}
var modeAsciidocExports = requireModeAsciidoc();
const modeAsciidoc = /* @__PURE__ */ getDefaultExportFromCjs(modeAsciidocExports);
const modeAsciidoc$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeAsciidoc
}, [modeAsciidocExports]);
export {
  modeAsciidoc$1 as m
};
