...
var extCode_lens$2 = { exports: {} };
var hasRequiredExtCode_lens;
function requireExtCode_lens() {
  if (hasRequiredExtCode_lens) return extCode_lens$2.exports;
  hasRequiredExtCode_lens = 1;
  (function(module, exports) {
    ace.define("ace/ext/code_lens", ["require", "exports", "module", "ace/line_widgets", "ace/lib/event", "ace/lib/lang", "ace/lib/dom", "ace/editor", "ace/config"], function(require2, exports2, module2) {
      ...
      function renderWidgets(changes, renderer) {
        ...
        for (var i = 0; i < textCells.length; i++) {
          ...
          for (var j = 0; j < lenses.length; j++) {
            ...
            if (!el) {
              if (j != 0)
                lensContainer.appendChild(dom.createTextNode(" | "));
      ...
      exports2.setLenses = function(session, lenses) {
      ...
      function attachToEditor(editor) {
        ...
        editor.$updateLenses = function() {
          ...
          function applyLenses() {
            ...
            var firstRow = exports2.setLenses(session, lenses);
      ...
      exports2.registerCodeLensProvider = function(editor, codeLensProvider) {
        editor.setOption("enableCodeLens", true);
        editor.codeLensProviders.push(codeLensProvider);
        editor.$updateLensesOnInput();
      };
      exports2.clear = function(session) {
        exports2.setLenses(session, null);
      };
  ...
  return extCode_lens$2.exports;
}
var extCode_lensExports = requireExtCode_lens();
const extCode_lens = /* @__PURE__ */ getDefaultExportFromCjs(extCode_lensExports);
const extCode_lens$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: extCode_lens
}, [extCode_lensExports]);
export {
  extCode_lens$1 as e
};
