...
var modeAql$2 = { exports: {} };
var hasRequiredModeAql;
function requireModeAql() {
  if (hasRequiredModeAql) return modeAql$2.exports;
  hasRequiredModeAql = 1;
  (function(module, exports) {
    ace.define("ace/mode/aql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.AqlHighlightRules = AqlHighlightRules;
    });
    ace.define("ace/mode/aql", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/aql_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var AqlHighlightRules = require2("./aql_highlight_rules").AqlHighlightRules;
      var Mode = function() {
  ...
  return modeAql$2.exports;
}
var modeAqlExports = requireModeAql();
const modeAql = /* @__PURE__ */ getDefaultExportFromCjs(modeAqlExports);
const modeAql$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeAql
}, [modeAqlExports]);
export {
