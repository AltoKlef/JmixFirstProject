...
var modeMaze$2 = { exports: {} };
var hasRequiredModeMaze;
function requireModeMaze() {
  if (hasRequiredModeMaze) return modeMaze$2.exports;
  hasRequiredModeMaze = 1;
  (function(module, exports) {
    ace.define("ace/mode/maze_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.MazeHighlightRules = MazeHighlightRules;
    });
    ...
    ace.define("ace/mode/maze", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/maze_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var MazeHighlightRules = require2("./maze_highlight_rules").MazeHighlightRules;
  ...
  return modeMaze$2.exports;
}
var modeMazeExports = requireModeMaze();
const modeMaze = /* @__PURE__ */ getDefaultExportFromCjs(modeMazeExports);
const modeMaze$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeMaze
}, [modeMazeExports]);
export {
