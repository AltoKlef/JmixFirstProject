...
var modeJsoniq$2 = { exports: {} };
var hasRequiredModeJsoniq;
function requireModeJsoniq() {
  if (hasRequiredModeJsoniq) return modeJsoniq$2.exports;
  hasRequiredModeJsoniq = 1;
  (function(module, exports) {
    ace.define("ace/mode/xquery/jsoniq_lexer", ["require", "exports", "module"], function(require2, exports2, module2) {
      module2.exports = function outer(modules, cache, entry) {
      ...
      }({ "/node_modules/xqlint/lib/lexers/JSONiqTokenizer.js": [function(_dereq_, module3, exports3) {
        var JSONiqTokenizer = exports3.JSONiqTokenizer = function JSONiqTokenizer2(string, parsingEventHandler) {
          init(string, parsingEventHandler);
          var self = this;
          this.ParseException = function(b, e, s, o, x) {
            var begin2 = b, end2 = e, state = s, offending = o, expected = x;
          ...
          function init(string2, parsingEventHandler2) {
            eventHandler = parsingEventHandler2;
            input = string2;
            size = string2.length;
            reset(0, 0, 0);
          }
          ...
          this.getOffendingToken = function(e) {
            ...
            return o >= 0 ? JSONiqTokenizer2.TOKEN[o] : null;
          };
          this.getExpectedTokenSet = function(e) {
            var expected;
            if (e.getExpected() < 0) {
              expected = JSONiqTokenizer2.getTokenSet(-e.getState());
            } else {
              expected = [JSONiqTokenizer2.TOKEN[e.getExpected()]];
            }
            return expected;
          };
          this.getErrorMessage = function(e) {
            ...
            var size2 = e.getEnd() - e.getBegin();
            return e.getMessage() + (found == null ? "" : ", found " + found) + "\nwhile expecting " + (tokenSet.length == 1 ? tokenSet[0] : "[" + tokenSet.join(", ") + "]") + "\n" + (size2 == 0 || found != null ? "" : "after successfully scanning " + size2 + " characters beginning ") + "at line " + line + ", column " + column + ":\n..." + input.substring(e.getBegin(), Math.min(input.length, e.getBegin() + 64)) + "...";
          };
          ...
          function shift(t) {
            if (l1 == t) {
              whitespace();
              eventHandler.terminal(JSONiqTokenizer2.TOKEN[l1], b1, e1 > size ? size : e1);
              b0 = b1;
              e0 = e1;
              l1 = 0;
            } else {
          ...
          function match(tokenSetId) {
            ...
            begin = end;
            var current = end;
            var result = JSONiqTokenizer2.INITIAL[tokenSetId];
            var state = 0;
            for (var code = result & 4095; code != 0; ) {
              ...
              ++current;
              if (c0 < 128) {
                charclass = JSONiqTokenizer2.MAP0[c0];
              } else if (c0 < 55296) {
                var c1 = c0 >> 4;
                charclass = JSONiqTokenizer2.MAP1[(c0 & 15) + JSONiqTokenizer2.MAP1[(c1 & 31) + JSONiqTokenizer2.MAP1[c1 >> 5]]];
              } else {
                if (c0 < 56320) {
                  var c1 = current < size ? input.charCodeAt(current) : 0;
                  if (c1 >= 56320 && c1 < 57344) {
                    ++current;
                    c0 = ((c0 & 1023) << 10) + (c1 & 1023) + 65536;
                    nonbmp = true;
                  }
                }
                var lo = 0, hi = 5;
                for (var m = 3; ; m = hi + lo >> 1) {
                  if (JSONiqTokenizer2.MAP2[m] > c0) hi = m - 1;
                  else if (JSONiqTokenizer2.MAP2[6 + m] < c0) lo = m + 1;
                  else {
                    charclass = JSONiqTokenizer2.MAP2[12 + m];
                    break;
                  }
                  if (lo > hi) {
                    charclass = 0;
              ...
              code = JSONiqTokenizer2.TRANSITION[(i0 & 15) + JSONiqTokenizer2.TRANSITION[i0 >> 4]];
              if (code > 4095) {
                result = code;
                code &= 4095;
                end = current;
      ...
      }, {}], "/node_modules/xqlint/lib/lexers/jsoniq_lexer.js": [function(_dereq_, module3, exports3) {
        ...
        exports3.JSONiqLexer = function() {
          return new Lexer(JSONiqTokenizer, Rules);
        };
      }, { "./JSONiqTokenizer": "/node_modules/xqlint/lib/lexers/JSONiqTokenizer.js", "./lexer": "/node_modules/xqlint/lib/lexers/lexer.js" }], "/node_modules/xqlint/lib/lexers/lexer.js": [function(_dereq_, module3, exports3) {
        ...
        exports3.Lexer = function(Tokenizer, Rules) {
          this.tokens = [];
    ...
    ace.define("ace/mode/behaviour/xquery", ["require", "exports", "module", "ace/lib/oop", "ace/mode/behaviour", "ace/mode/behaviour/cstyle", "ace/mode/behaviour/xml", "ace/token_iterator"], function(require2, exports2, module2) {
      var oop = require2("../../lib/oop");
      var Behaviour = require2("../behaviour").Behaviour;
      ...
      exports2.XQueryBehaviour = XQueryBehaviour;
    });
    ...
    ace.define("ace/mode/jsoniq", ["require", "exports", "module", "ace/worker/worker_client", "ace/lib/oop", "ace/mode/text", "ace/mode/text_highlight_rules", "ace/mode/xquery/jsoniq_lexer", "ace/range", "ace/mode/behaviour/xquery", "ace/mode/folding/cstyle", "ace/anchor"], function(require2, exports2, module2) {
      ...
      var JSONiqLexer = require2("./xquery/jsoniq_lexer").JSONiqLexer;
      var Range = require2("../range").Range;
      var XQueryBehaviour = require2("./behaviour/xquery").XQueryBehaviour;
      ...
      (function() {
        this.completer = {
          getCompletions: function(editor, session, pos, prefix, callback) {
            if (!session.$worker)
              return callback();
            session.$worker.emit("complete", { data: { pos, prefix } });
        ...
        this.addMarkers = function(annos, mySession) {
          ...
          annos.forEach(function(anno) {
            ...
            var markerId;
            anno.pos.ec - anno.pos.sc;
            anno.pos.el - anno.pos.sl;
            var gutterAnno = {
            ...
            function updateFloat(single) {
              ...
              if (anno.pos.sc !== void 0 && anno.pos.ec !== void 0) {
  ...
  return modeJsoniq$2.exports;
}
var modeJsoniqExports = requireModeJsoniq();
const modeJsoniq = /* @__PURE__ */ getDefaultExportFromCjs(modeJsoniqExports);
const modeJsoniq$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeJsoniq
}, [modeJsoniqExports]);
export {
