...
var modeMakefile$2 = { exports: {} };
var hasRequiredModeMakefile;
function requireModeMakefile() {
  if (hasRequiredModeMakefile) return modeMakefile$2.exports;
  hasRequiredModeMakefile = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/makefile_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/sh_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var ShHighlightFile = require2("./sh_highlight_rules");
      ...
      exports2.MakefileHighlightRules = MakefileHighlightRules;
    });
    ...
    ace.define("ace/mode/makefile", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/makefile_highlight_rules", "ace/mode/folding/coffee"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var MakefileHighlightRules = require2("./makefile_highlight_rules").MakefileHighlightRules;
  ...
  return modeMakefile$2.exports;
}
var modeMakefileExports = requireModeMakefile();
const modeMakefile = /* @__PURE__ */ getDefaultExportFromCjs(modeMakefileExports);
const modeMakefile$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeMakefile
}, [modeMakefileExports]);
export {
  modeMakefile$1 as m
};
