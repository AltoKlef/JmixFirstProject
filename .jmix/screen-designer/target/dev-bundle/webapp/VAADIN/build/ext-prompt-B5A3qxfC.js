...
var extPrompt$2 = { exports: {} };
var hasRequiredExtPrompt;
function requireExtPrompt() {
  if (hasRequiredExtPrompt) return extPrompt$2.exports;
  hasRequiredExtPrompt = 1;
  (function(module, exports) {
    ...
    ace.define("ace/autocomplete", ["require", "exports", "module", "ace/keyboard/hash_handler", "ace/autocomplete/popup", "ace/autocomplete/inline", "ace/autocomplete/popup", "ace/autocomplete/util", "ace/lib/lang", "ace/lib/dom", "ace/snippets", "ace/config"], function(require2, exports2, module2) {
      ...
      var Autocomplete = (
        ...
        function() {
          ...
          Autocomplete2.prototype.getCompletionProvider = function() {
            if (!this.completionProvider)
    ...
    ace.define("ace/ext/prompt", ["require", "exports", "module", "ace/range", "ace/lib/dom", "ace/ext/menu_tools/get_editor_keyboard_shortcuts", "ace/autocomplete", "ace/autocomplete/popup", "ace/autocomplete/popup", "ace/undomanager", "ace/tokenizer", "ace/ext/menu_tools/overlay_page", "ace/ext/modelist"], function(require2, exports2, module2) {
      var Range = require2("../range").Range;
      var dom = require2("../lib/dom");
      require2("../ext/menu_tools/get_editor_keyboard_shortcuts");
      var FilteredList = require2("../autocomplete").FilteredList;
      var AcePopup = require2("../autocomplete/popup").AcePopup;
      var $singleLineEditor = require2("../autocomplete/popup").$singleLineEditor;
  ...
  return extPrompt$2.exports;
}
var extPromptExports = requireExtPrompt();
const extPrompt = /* @__PURE__ */ getDefaultExportFromCjs(extPromptExports);
const extPrompt$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: extPrompt
}, [extPromptExports]);
export {
