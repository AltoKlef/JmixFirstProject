...
var workerYaml$2 = {};
var hasRequiredWorkerYaml;
function requireWorkerYaml() {
  if (hasRequiredWorkerYaml) return workerYaml$2;
  hasRequiredWorkerYaml = 1;
  !function(window2) {
  ...
  ace.define("ace/mode/yaml/yaml-lint", [], function(require2, exports, module) {
    var $build_deps$ = { require: require2, exports, module };
    exports = void 0;
    module = void 0;
    function define(name, deps, m) {
      ...
      var ret = typeof m == "function" ? m.apply($build_deps$.module, deps.map(function(n) {
        return $build_deps$[n] || require2(n);
      })) : m;
      if (ret != void 0) $build_deps$.module.exports = ret;
    }
    define.amd = true;
    (function(f) {
      ...
      return (/* @__PURE__ */ function() {
        function r(e, n, t) {
          ...
          for (var u = typeof require2 == "function" && require2, i = 0; i < t.length; i++) o(t[i]);
          return o;
        }
        return r;
      }())({ 1: [function(require3, module2, exports2) {
      }, {}], 2: [function(require3, module2, exports2) {
        require3("fs");
        var merge = require3("lodash.merge");
        var yaml = require3("js-yaml");
      ...
      }, { "fs": 1, "js-yaml": 3, "lodash.merge": 33 }], 3: [function(require3, module2, exports2) {
        var yaml = require3("./lib/js-yaml.js");
        module2.exports = yaml;
      }, { "./lib/js-yaml.js": 4 }], 4: [function(require3, module2, exports2) {
        var loader = require3("./js-yaml/loader");
        var dumper = require3("./js-yaml/dumper");
        function deprecated(name) {
          return function() {
            throw new Error("Function " + name + " is deprecated and cannot be used.");
          };
        }
        module2.exports.Type = require3("./js-yaml/type");
        module2.exports.Schema = require3("./js-yaml/schema");
        module2.exports.FAILSAFE_SCHEMA = require3("./js-yaml/schema/failsafe");
        module2.exports.JSON_SCHEMA = require3("./js-yaml/schema/json");
        module2.exports.CORE_SCHEMA = require3("./js-yaml/schema/core");
        module2.exports.DEFAULT_SAFE_SCHEMA = require3("./js-yaml/schema/default_safe");
        module2.exports.DEFAULT_FULL_SCHEMA = require3("./js-yaml/schema/default_full");
        ...
        module2.exports.YAMLException = require3("./js-yaml/exception");
        module2.exports.MINIMAL_SCHEMA = require3("./js-yaml/schema/failsafe");
        module2.exports.SAFE_SCHEMA = require3("./js-yaml/schema/default_safe");
        module2.exports.DEFAULT_SCHEMA = require3("./js-yaml/schema/default_full");
        module2.exports.scan = deprecated("scan");
        module2.exports.parse = deprecated("parse");
        module2.exports.compose = deprecated("compose");
        module2.exports.addConstructor = deprecated("addConstructor");
      }, { "./js-yaml/dumper": 6, "./js-yaml/exception": 7, "./js-yaml/loader": 8, "./js-yaml/schema": 10, "./js-yaml/schema/core": 11, "./js-yaml/schema/default_full": 12, "./js-yaml/schema/default_safe": 13, "./js-yaml/schema/failsafe": 14, "./js-yaml/schema/json": 15, "./js-yaml/type": 16 }], 5: [function(require3, module2, exports2) {
      ...
      }, {}], 6: [function(require3, module2, exports2) {
        var common = require3("./common");
        var YAMLException = require3("./exception");
        var DEFAULT_FULL_SCHEMA = require3("./schema/default_full");
        var DEFAULT_SAFE_SCHEMA = require3("./schema/default_safe");
        ...
        function isPrintable(c) {
          return c >= 32 && c <= 126 || c >= 161 && c <= 55295 && c !== 8232 && c !== 8233 || c >= 57344 && c <= 65533 && c !== 65279 || c >= 65536 && c <= 1114111;
        }
      ...
      }, { "./common": 5, "./exception": 7, "./schema/default_full": 12, "./schema/default_safe": 13 }], 7: [function(require3, module2, exports2) {
      ...
      }, {}], 8: [function(require3, module2, exports2) {
        var common = require3("./common");
        var YAMLException = require3("./exception");
        var Mark = require3("./mark");
        var DEFAULT_SAFE_SCHEMA = require3("./schema/default_safe");
        var DEFAULT_FULL_SCHEMA = require3("./schema/default_full");
        var _hasOwnProperty = Object.prototype.hasOwnProperty;
      ...
      }, { "./common": 5, "./exception": 7, "./mark": 9, "./schema/default_full": 12, "./schema/default_safe": 13 }], 9: [function(require3, module2, exports2) {
        var common = require3("./common");
      ...
      }, { "./common": 5 }], 10: [function(require3, module2, exports2) {
        var common = require3("./common");
        var YAMLException = require3("./exception");
        var Type = require3("./type");
      ...
      }, { "./common": 5, "./exception": 7, "./type": 16 }], 11: [function(require3, module2, exports2) {
        var Schema = require3("../schema");
        module2.exports = new Schema({
          include: [
            require3("./json")
          ]
        });
      }, { "../schema": 10, "./json": 15 }], 12: [function(require3, module2, exports2) {
        var Schema = require3("../schema");
        module2.exports = Schema.DEFAULT = new Schema({
          include: [
            require3("./default_safe")
          ],
          explicit: [
            require3("../type/js/undefined"),
            require3("../type/js/regexp"),
            require3("../type/js/function")
          ]
        });
      }, { "../schema": 10, "../type/js/function": 21, "../type/js/regexp": 22, "../type/js/undefined": 23, "./default_safe": 13 }], 13: [function(require3, module2, exports2) {
        var Schema = require3("../schema");
        module2.exports = new Schema({
          include: [
            require3("./core")
          ...
          implicit: [
            require3("../type/timestamp"),
            require3("../type/merge")
          ],
          explicit: [
            require3("../type/binary"),
            require3("../type/omap"),
            require3("../type/pairs"),
            require3("../type/set")
          ]
        });
      }, { "../schema": 10, "../type/binary": 17, "../type/merge": 25, "../type/omap": 27, "../type/pairs": 28, "../type/set": 30, "../type/timestamp": 32, "./core": 11 }], 14: [function(require3, module2, exports2) {
        var Schema = require3("../schema");
        module2.exports = new Schema({
          explicit: [
            require3("../type/str"),
      ...
      }, { "../schema": 10, "../type/map": 24, "../type/seq": 29, "../type/str": 31 }], 15: [function(require3, module2, exports2) {
        var Schema = require3("../schema");
        module2.exports = new Schema({
          include: [
            require3("./failsafe")
      ...
      }, { "../schema": 10, "../type/bool": 18, "../type/float": 19, "../type/int": 20, "../type/null": 26, "./failsafe": 14 }], 16: [function(require3, module2, exports2) {
        var YAMLException = require3("./exception");
      ...
      }, { "./exception": 7 }], 17: [function(require3, module2, exports2) {
        var NodeBuffer;
        try {
          var _require = require3;
      ...
      }, { "../type": 16 }], 18: [function(require3, module2, exports2) {
        var Type = require3("../type");
      ...
      }, { "../type": 16 }], 19: [function(require3, module2, exports2) {
        var common = require3("../common");
        var Type = require3("../type");
      ...
      }, { "../common": 5, "../type": 16 }], 20: [function(require3, module2, exports2) {
        var common = require3("../common");
        var Type = require3("../type");
      ...
      }, { "../common": 5, "../type": 16 }], 21: [function(require3, module2, exports2) {
        var esprima;
        try {
          var _require = require3;
      ...
      }, { "../../type": 16 }], 22: [function(require3, module2, exports2) {
        var Type = require3("../../type");
      ...
      }, { "../../type": 16 }], 23: [function(require3, module2, exports2) {
        var Type = require3("../../type");
      ...
      }, { "../../type": 16 }], 24: [function(require3, module2, exports2) {
        var Type = require3("../type");
      ...
      }, { "../type": 16 }], 25: [function(require3, module2, exports2) {
        var Type = require3("../type");
      ...
      }, { "../type": 16 }], 26: [function(require3, module2, exports2) {
        var Type = require3("../type");
      ...
      }, { "../type": 16 }], 27: [function(require3, module2, exports2) {
        var Type = require3("../type");
        var _hasOwnProperty = Object.prototype.hasOwnProperty;
        var _toString = Object.prototype.toString;
      ...
      }, { "../type": 16 }], 28: [function(require3, module2, exports2) {
        var Type = require3("../type");
        var _toString = Object.prototype.toString;
      ...
      }, { "../type": 16 }], 29: [function(require3, module2, exports2) {
        var Type = require3("../type");
      ...
      }, { "../type": 16 }], 30: [function(require3, module2, exports2) {
        var Type = require3("../type");
        var _hasOwnProperty = Object.prototype.hasOwnProperty;
      ...
      }, { "../type": 16 }], 31: [function(require3, module2, exports2) {
        var Type = require3("../type");
      ...
      }, { "../type": 16 }], 32: [function(require3, module2, exports2) {
        var Type = require3("../type");
      ...
      }, { "../type": 16 }], 33: [function(require3, module2, exports2) {
        (function(global) {
  ...
  ace.define("ace/mode/yaml_worker", [], function(require2, exports) {
    var oop = require2("../lib/oop");
    var Mirror = require2("../worker/mirror").Mirror;
    var lint = require2("./yaml/yaml-lint").lint;
...
var workerYamlExports = requireWorkerYaml();
const workerYaml = /* @__PURE__ */ getDefaultExportFromCjs(workerYamlExports);
const workerYaml$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: workerYaml
}, [workerYamlExports]);
export {
