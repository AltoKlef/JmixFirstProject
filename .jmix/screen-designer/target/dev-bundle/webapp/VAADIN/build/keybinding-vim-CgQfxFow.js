...
var keybindingVim$2 = { exports: {} };
var hasRequiredKeybindingVim;
function requireKeybindingVim() {
  if (hasRequiredKeybindingVim) return keybindingVim$2.exports;
  hasRequiredKeybindingVim = 1;
  (function(module, exports) {
    ...
    ace.define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/ext/hardwrap", "ace/multi_select"], function(require2, exports2, module2) {
      ...
      var multiSelectCommands = require2("../commands/multi_select_commands");
      var TextModeTokenRe = require2("../mode/text").Mode.prototype.tokenRe;
      var hardWrap = require2("../ext/hardwrap").hardWrap;
      require2("../multi_select");
      var CodeMirror = function(ace2) {
        this.ace = ace2;
        this.state = {};
        this.marks = {};
        this.options = {};
      ...
      (function() {
        ...
        this.scanForBracket = function(pos, dir, _, options2) {
          var re = options2.bracketRegex.source;
      ...
      function makePrompt(prefix, desc) {
        return dom(document.createDocumentFragment(), dom("span", { $fontFamily: "monospace", $whiteSpace: "pre" }, prefix, dom("input", {
          type: "text",
          autocorrect: "off",
          autocapitalize: "off",
          spellcheck: "false"
      ...
      function delayedExecAceCommand(op, ace2) {
        ace2.off("beforeEndOperation", delayedExecAceCommand);
        var cmd = ace2.state.cm.vimCmd;
        if (cmd) {
          ace2.execCommand(cmd.exec ? cmd : cmd.name, cmd.args);
        }
        ace2.curOp = ace2.prevOp;
      }
  ...
  return keybindingVim$2.exports;
}
var keybindingVimExports = requireKeybindingVim();
const keybindingVim = /* @__PURE__ */ getDefaultExportFromCjs(keybindingVimExports);
const keybindingVim$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: keybindingVim
}, [keybindingVimExports]);
export {
  keybindingVim$1 as k
};
