...
var modeGroovy$2 = { exports: {} };
var hasRequiredModeGroovy;
function requireModeGroovy() {
  if (hasRequiredModeGroovy) return modeGroovy$2.exports;
  hasRequiredModeGroovy = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/groovy_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/doc_comment_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var DocCommentHighlightRules = require2("./doc_comment_highlight_rules").DocCommentHighlightRules;
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.GroovyHighlightRules = GroovyHighlightRules;
    });
    ace.define("ace/mode/groovy", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/mode/groovy_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var JavaScriptMode = require2("./javascript").Mode;
      var GroovyHighlightRules = require2("./groovy_highlight_rules").GroovyHighlightRules;
      var Mode = function() {
  ...
  return modeGroovy$2.exports;
}
var modeGroovyExports = requireModeGroovy();
const modeGroovy = /* @__PURE__ */ getDefaultExportFromCjs(modeGroovyExports);
const modeGroovy$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeGroovy
}, [modeGroovyExports]);
export {
