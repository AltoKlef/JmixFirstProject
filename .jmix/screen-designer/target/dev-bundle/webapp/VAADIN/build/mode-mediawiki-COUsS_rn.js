...
var modeMediawiki$2 = { exports: {} };
var hasRequiredModeMediawiki;
function requireModeMediawiki() {
  if (hasRequiredModeMediawiki) return modeMediawiki$2.exports;
  hasRequiredModeMediawiki = 1;
  (function(module, exports) {
    ace.define("ace/mode/mediawiki_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.MediaWikiHighlightRules = MediaWikiHighlightRules;
    });
    ace.define("ace/mode/mediawiki", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/mediawiki_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var MediaWikiHighlightRules = require2("./mediawiki_highlight_rules").MediaWikiHighlightRules;
      var Mode = function() {
  ...
  return modeMediawiki$2.exports;
}
var modeMediawikiExports = requireModeMediawiki();
const modeMediawiki = /* @__PURE__ */ getDefaultExportFromCjs(modeMediawikiExports);
const modeMediawiki$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeMediawiki
}, [modeMediawikiExports]);
export {
  modeMediawiki$1 as m
};
