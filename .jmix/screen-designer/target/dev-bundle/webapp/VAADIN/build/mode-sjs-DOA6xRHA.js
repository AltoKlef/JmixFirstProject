...
var modeSjs$2 = { exports: {} };
var hasRequiredModeSjs;
function requireModeSjs() {
  if (hasRequiredModeSjs) return modeSjs$2.exports;
  hasRequiredModeSjs = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/sjs_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var JavaScriptHighlightRules = require2("./javascript_highlight_rules").JavaScriptHighlightRules;
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.SJSHighlightRules = SJSHighlightRules;
    });
    ace.define("ace/mode/sjs", ["require", "exports", "module", "ace/lib/oop", "ace/mode/javascript", "ace/mode/sjs_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var JSMode = require2("./javascript").Mode;
      var SJSHighlightRules = require2("./sjs_highlight_rules").SJSHighlightRules;
      var MatchingBraceOutdent = require2("./matching_brace_outdent").MatchingBraceOutdent;
      var CstyleBehaviour = require2("./behaviour/cstyle").CstyleBehaviour;
      var CStyleFoldMode = require2("./folding/cstyle").FoldMode;
      var Mode = function() {
  ...
  return modeSjs$2.exports;
}
var modeSjsExports = requireModeSjs();
const modeSjs = /* @__PURE__ */ getDefaultExportFromCjs(modeSjsExports);
const modeSjs$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeSjs
}, [modeSjsExports]);
export {
