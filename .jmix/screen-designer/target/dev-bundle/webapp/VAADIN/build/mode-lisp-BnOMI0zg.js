...
var modeLisp$2 = { exports: {} };
var hasRequiredModeLisp;
function requireModeLisp() {
  if (hasRequiredModeLisp) return modeLisp$2.exports;
  hasRequiredModeLisp = 1;
  (function(module, exports) {
    ace.define("ace/mode/lisp_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.LispHighlightRules = LispHighlightRules;
    });
    ace.define("ace/mode/lisp", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/lisp_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var LispHighlightRules = require2("./lisp_highlight_rules").LispHighlightRules;
      var Mode = function() {
  ...
  return modeLisp$2.exports;
}
var modeLispExports = requireModeLisp();
const modeLisp = /* @__PURE__ */ getDefaultExportFromCjs(modeLispExports);
const modeLisp$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeLisp
}, [modeLispExports]);
export {
