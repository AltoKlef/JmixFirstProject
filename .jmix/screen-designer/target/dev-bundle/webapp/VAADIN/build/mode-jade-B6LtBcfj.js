...
var modeJade$2 = { exports: {} };
var hasRequiredModeJade;
function requireModeJade() {
  if (hasRequiredModeJade) return modeJade$2.exports;
  hasRequiredModeJade = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/jade_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/markdown_highlight_rules", "ace/mode/scss_highlight_rules", "ace/mode/less_highlight_rules", "ace/mode/coffee_highlight_rules", "ace/mode/javascript_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      require2("./markdown_highlight_rules").MarkdownHighlightRules;
      require2("./scss_highlight_rules").ScssHighlightRules;
      require2("./less_highlight_rules").LessHighlightRules;
      require2("./coffee_highlight_rules").CoffeeHighlightRules;
      var JavaScriptHighlightRules = require2("./javascript_highlight_rules").JavaScriptHighlightRules;
    ...
    ace.define("ace/mode/jade", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/jade_highlight_rules", "ace/mode/folding/coffee"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
  ...
  return modeJade$2.exports;
}
var modeJadeExports = requireModeJade();
const modeJade = /* @__PURE__ */ getDefaultExportFromCjs(modeJadeExports);
const modeJade$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeJade
}, [modeJadeExports]);
export {
