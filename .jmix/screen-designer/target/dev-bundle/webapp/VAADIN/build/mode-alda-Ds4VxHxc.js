...
var modeAlda$2 = { exports: {} };
var hasRequiredModeAlda;
function requireModeAlda() {
  if (hasRequiredModeAlda) return modeAlda$2.exports;
  hasRequiredModeAlda = 1;
  (function(module, exports) {
    ace.define("ace/mode/alda_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.AldaHighlightRules = AldaHighlightRules;
    });
    ...
    ace.define("ace/mode/alda", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/alda_highlight_rules", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var AldaHighlightRules = require2("./alda_highlight_rules").AldaHighlightRules;
  ...
  return modeAlda$2.exports;
}
var modeAldaExports = requireModeAlda();
const modeAlda = /* @__PURE__ */ getDefaultExportFromCjs(modeAldaExports);
const modeAlda$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeAlda
}, [modeAldaExports]);
export {
