...
var modeLatte$2 = { exports: {} };
var hasRequiredModeLatte;
function requireModeLatte() {
  if (hasRequiredModeLatte) return modeLatte$2.exports;
  hasRequiredModeLatte = 1;
  (function(module, exports) {
    ...
    ace.define("ace/mode/latte_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html_highlight_rules", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlHighlightRules = require2("./html_highlight_rules").HtmlHighlightRules;
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      ...
      exports2.LatteHighlightRules = LatteHighlightRules;
    });
    ace.define("ace/mode/latte", ["require", "exports", "module", "ace/lib/oop", "ace/mode/html", "ace/mode/latte_highlight_rules", "ace/mode/matching_brace_outdent"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var HtmlMode = require2("./html").Mode;
      var LatteHighlightRules = require2("./latte_highlight_rules").LatteHighlightRules;
      var MatchingBraceOutdent = require2("./matching_brace_outdent").MatchingBraceOutdent;
      var Mode = function() {
        HtmlMode.call(this);
  ...
  return modeLatte$2.exports;
}
var modeLatteExports = requireModeLatte();
const modeLatte = /* @__PURE__ */ getDefaultExportFromCjs(modeLatteExports);
const modeLatte$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modeLatte
}, [modeLatteExports]);
export {
