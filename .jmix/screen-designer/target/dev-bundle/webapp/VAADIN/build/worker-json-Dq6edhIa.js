...
var workerJson$2 = {};
var hasRequiredWorkerJson;
function requireWorkerJson() {
  if (hasRequiredWorkerJson) return workerJson$2;
  hasRequiredWorkerJson = 1;
  !function(window) {
  ...
  ace.define("ace/mode/json/json_parse", [], function(require2, exports, module) {
    var at, ch, escapee = {
      '"': '"',
      "\\": "\\",
      "/": "/",
  ...
  ace.define("ace/mode/json_worker", [], function(require2, exports, module) {
    var oop = require2("../lib/oop");
...
var workerJsonExports = requireWorkerJson();
const workerJson = /* @__PURE__ */ getDefaultExportFromCjs(workerJsonExports);
const workerJson$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: workerJson
}, [workerJsonExports]);
export {
