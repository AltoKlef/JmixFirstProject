...
var workerCss$2 = {};
var hasRequiredWorkerCss;
function requireWorkerCss() {
  if (hasRequiredWorkerCss) return workerCss$2;
  hasRequiredWorkerCss = 1;
  !function(window) {
  ...
  ace.define("ace/mode/css/csslint", [], function(require2, exports, module) {
    var CSSLint = function() {
      var module2 = module2 || {};
      var parserlib = function() {
        var require3;
        require3 = (/* @__PURE__ */ function() {
          function r(e, n, t) {
            function o(i2, f) {
              if (!n[i2]) {
                if (!e[i2]) {
                  var c = "function" == typeof require3 && require3;
            ...
            for (var u = "function" == typeof require3 && require3, i = 0; i < t.length; i++) o(t[i]);
            return o;
          }
          return r;
        }())({ 1: [function(require4, module3, exports2) {
          module3.exports = {
            __proto__: null,
            aliceblue: "#f0f8ff",
            antiquewhite: "#faebd7",
        ...
        }, {}], 2: [function(require4, module3, exports2) {
          module3.exports = Combinator;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6 }], 3: [function(require4, module3, exports2) {
          module3.exports = Matcher;
          var StringReader = require4("../util/StringReader");
          var SyntaxError = require4("../util/SyntaxError");
          ...
          Matcher.fromType = function(type) {
            var ValidationTypes = require4("./ValidationTypes");
        ...
        }, { "../util/StringReader": 24, "../util/SyntaxError": 25, "./ValidationTypes": 21 }], 4: [function(require4, module3, exports2) {
          module3.exports = MediaFeature;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6 }], 5: [function(require4, module3, exports2) {
          module3.exports = MediaQuery;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6 }], 6: [function(require4, module3, exports2) {
          module3.exports = Parser;
          var EventTarget = require4("../util/EventTarget");
          var SyntaxError = require4("../util/SyntaxError");
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Combinator = require4("./Combinator");
          var MediaFeature = require4("./MediaFeature");
          var MediaQuery = require4("./MediaQuery");
          var PropertyName = require4("./PropertyName");
          var PropertyValue = require4("./PropertyValue");
          var PropertyValuePart = require4("./PropertyValuePart");
          var Selector = require4("./Selector");
          var SelectorPart = require4("./SelectorPart");
          var SelectorSubPart = require4("./SelectorSubPart");
          var TokenStream = require4("./TokenStream");
          var Tokens = require4("./Tokens");
          var Validation = require4("./Validation");
          ...
          Parser.prototype = function() {
            var proto = new EventTarget(), prop, additions = {
              ...
              _property: function() {
                var tokenStream = this._tokenStream, value = null, hack = null, propertyName = "", token, line, col;
        ...
        }, { "../util/EventTarget": 23, "../util/SyntaxError": 25, "../util/SyntaxUnit": 26, "./Combinator": 2, "./MediaFeature": 4, "./MediaQuery": 5, "./PropertyName": 8, "./PropertyValue": 9, "./PropertyValuePart": 11, "./Selector": 13, "./SelectorPart": 14, "./SelectorSubPart": 15, "./TokenStream": 17, "./Tokens": 18, "./Validation": 19 }], 7: [function(require4, module3, exports2) {
          module3.exports = {
            __proto__: null,
        ...
        }, {}], 8: [function(require4, module3, exports2) {
          module3.exports = PropertyName;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6 }], 9: [function(require4, module3, exports2) {
          module3.exports = PropertyValue;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6 }], 10: [function(require4, module3, exports2) {
          module3.exports = PropertyValueIterator;
        ...
        }, {}], 11: [function(require4, module3, exports2) {
          module3.exports = PropertyValuePart;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Colors = require4("./Colors");
          var Parser = require4("./Parser");
          var Tokens = require4("./Tokens");
        ...
        }, { "../util/SyntaxUnit": 26, "./Colors": 1, "./Parser": 6, "./Tokens": 18 }], 12: [function(require4, module3, exports2) {
          var Pseudos = module3.exports = {
            __proto__: null,
            ":first-letter": 1,
            ":first-line": 1,
            ":before": 1,
        ...
        }, {}], 13: [function(require4, module3, exports2) {
          module3.exports = Selector;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
          var Specificity = require4("./Specificity");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6, "./Specificity": 16 }], 14: [function(require4, module3, exports2) {
          module3.exports = SelectorPart;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6 }], 15: [function(require4, module3, exports2) {
          module3.exports = SelectorSubPart;
          var SyntaxUnit = require4("../util/SyntaxUnit");
          var Parser = require4("./Parser");
        ...
        }, { "../util/SyntaxUnit": 26, "./Parser": 6 }], 16: [function(require4, module3, exports2) {
          module3.exports = Specificity;
          var Pseudos = require4("./Pseudos");
          var SelectorPart = require4("./SelectorPart");
        ...
        }, { "./Pseudos": 12, "./SelectorPart": 14 }], 17: [function(require4, module3, exports2) {
          module3.exports = TokenStream;
          var TokenStreamBase = require4("../util/TokenStreamBase");
          var PropertyValuePart = require4("./PropertyValuePart");
          var Tokens = require4("./Tokens");
          ...
          TokenStream.prototype = mix(new TokenStreamBase(), {
            ...
            _getDefaultToken: function(c, startLine, startCol) {
              var reader = this._reader, token = null;
              if (isDigit(c)) {
                token = this.numberToken(c, startLine, startCol);
        ...
        }, { "../util/TokenStreamBase": 27, "./PropertyValuePart": 11, "./Tokens": 18 }], 18: [function(require4, module3, exports2) {
          var Tokens = module3.exports = [
            { name: "CDO" },
            { name: "CDC" },
            {
              name: "S",
        ...
        }, {}], 19: [function(require4, module3, exports2) {
          var Matcher = require4("./Matcher");
          var Properties = require4("./Properties");
          var ValidationTypes = require4("./ValidationTypes");
          var ValidationError = require4("./ValidationError");
          var PropertyValueIterator = require4("./PropertyValueIterator");
          module3.exports = {
        ...
        }, { "./Matcher": 3, "./Properties": 7, "./PropertyValueIterator": 10, "./ValidationError": 20, "./ValidationTypes": 21 }], 20: [function(require4, module3, exports2) {
          module3.exports = ValidationError;
        ...
        }, {}], 21: [function(require4, module3, exports2) {
          var ValidationTypes = module3.exports;
          var Matcher = require4("./Matcher");
        ...
        }, { "./Matcher": 3 }], 22: [function(require4, module3, exports2) {
          module3.exports = {
            Colors: require4("./Colors"),
            Combinator: require4("./Combinator"),
            Parser: require4("./Parser"),
            PropertyName: require4("./PropertyName"),
            PropertyValue: require4("./PropertyValue"),
            PropertyValuePart: require4("./PropertyValuePart"),
            Matcher: require4("./Matcher"),
            MediaFeature: require4("./MediaFeature"),
            MediaQuery: require4("./MediaQuery"),
            Selector: require4("./Selector"),
            SelectorPart: require4("./SelectorPart"),
            SelectorSubPart: require4("./SelectorSubPart"),
            Specificity: require4("./Specificity"),
            TokenStream: require4("./TokenStream"),
            Tokens: require4("./Tokens"),
            ValidationError: require4("./ValidationError")
          };
        }, { "./Colors": 1, "./Combinator": 2, "./Matcher": 3, "./MediaFeature": 4, "./MediaQuery": 5, "./Parser": 6, "./PropertyName": 8, "./PropertyValue": 9, "./PropertyValuePart": 11, "./Selector": 13, "./SelectorPart": 14, "./SelectorSubPart": 15, "./Specificity": 16, "./TokenStream": 17, "./Tokens": 18, "./ValidationError": 20 }], 23: [function(require4, module3, exports2) {
        ...
        }, {}], 24: [function(require4, module3, exports2) {
        ...
        }, {}], 25: [function(require4, module3, exports2) {
        ...
        }, {}], 26: [function(require4, module3, exports2) {
          module3.exports = SyntaxUnit;
        ...
        }, {}], 27: [function(require4, module3, exports2) {
          module3.exports = TokenStreamBase;
          var StringReader = require4("./StringReader");
          var SyntaxError = require4("./SyntaxError");
        ...
        }, { "./StringReader": 24, "./SyntaxError": 25 }], 28: [function(require4, module3, exports2) {
          module3.exports = {
            StringReader: require4("./StringReader"),
            SyntaxError: require4("./SyntaxError"),
            SyntaxUnit: require4("./SyntaxUnit"),
            EventTarget: require4("./EventTarget"),
            TokenStreamBase: require4("./TokenStreamBase")
          };
        }, { "./EventTarget": 23, "./StringReader": 24, "./SyntaxError": 25, "./SyntaxUnit": 26, "./TokenStreamBase": 27 }], "parserlib": [function(require4, module3, exports2) {
          module3.exports = {
            css: require4("./css"),
            util: require4("./util")
          };
        }, { "./css": 22, "./util": 28 }] }, {}, []);
        return require3("parserlib");
      }();
      var clone = function() {
      ...
      var CSSLint2 = function() {
        ...
        api.format = function(results, filename, formatId, options) {
          var formatter = api.getFormatter(formatId), result = null;
          if (formatter) {
        ...
        api.verify = function(text, ruleset) {
          var i = 0, reporter, lines, allow = {}, ignore = [], report, parser = new parserlib.css.Parser({
            starHack: true,
            ieFilters: true,
            underscoreHack: true,
            strict: false
                ...
                if (compatiblePrefixes.hasOwnProperty(prop2)) {
                  ...
                  if (CSSLint2.Util.indexOf(variations2, name.text) > -1) {
                    if (!propertyGroups[prop2]) {
                      propertyGroups[prop2] = {
                        full: variations2.slice(0),
                        actual: [],
                        actualNodes: []
                      };
                    }
  ...
  ace.define("ace/mode/css_worker", [], function(require2, exports, module) {
    var oop = require2("../lib/oop");
    var lang = require2("../lib/lang");
    var Mirror = require2("../worker/mirror").Mirror;
    var CSSLint = require2("./css/csslint").CSSLint;
...
var workerCssExports = requireWorkerCss();
const workerCss = /* @__PURE__ */ getDefaultExportFromCjs(workerCssExports);
const workerCss$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: workerCss
}, [workerCssExports]);
export {
