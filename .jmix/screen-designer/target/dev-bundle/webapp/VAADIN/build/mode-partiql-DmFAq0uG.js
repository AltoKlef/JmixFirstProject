...
var modePartiql$2 = { exports: {} };
var hasRequiredModePartiql;
function requireModePartiql() {
  if (hasRequiredModePartiql) return modePartiql$2.exports;
  hasRequiredModePartiql = 1;
  (function(module, exports) {
    ace.define("ace/mode/ion_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(require2, exports2, module2) {
      ...
      exports2.IonHighlightRules = IonHighlightRules;
    });
    ace.define("ace/mode/partiql_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules", "ace/mode/ion_highlight_rules"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextHighlightRules = require2("./text_highlight_rules").TextHighlightRules;
      var IonHighlightRules = require2("./ion_highlight_rules").IonHighlightRules;
      ...
      exports2.PartiqlHighlightRules = PartiqlHighlightRules;
    });
    ...
    ace.define("ace/mode/partiql", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/partiql_highlight_rules", "ace/mode/matching_brace_outdent", "ace/mode/behaviour/cstyle", "ace/mode/folding/cstyle"], function(require2, exports2, module2) {
      var oop = require2("../lib/oop");
      var TextMode = require2("./text").Mode;
      var HighlightRules = require2("./partiql_highlight_rules").PartiqlHighlightRules;
  ...
  return modePartiql$2.exports;
}
var modePartiqlExports = requireModePartiql();
const modePartiql = /* @__PURE__ */ getDefaultExportFromCjs(modePartiqlExports);
const modePartiql$1 = /* @__PURE__ */ _mergeNamespaces({
  __proto__: null,
  default: modePartiql
}, [modePartiqlExports]);
export {
